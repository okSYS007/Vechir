...
// Определить, что испоьлзуется базовая версия конфигурации.
//
// Возвращаемое значение:
...
Процедура ОтправитьЭлектроннуюПочту(Знач ИмяПользователя, 
	...
	ВызватьИсключение НСтр("ru='Отсуствует возможность отправки электронной почты.';uk='Відсутня можливість відправлення електронної пошти.'"); 	
