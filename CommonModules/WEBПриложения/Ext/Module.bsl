	...
	Для Индекс = 0 По ТабличнаяЧасть.Количество() - 1 Цикл
		...
		Если ЗначениеЗаполнено(СтрокаТабличнойЧасти.Номенклатура) Тогда
			...
			Если ОбщегоНазначения.ЕстьРеквизитТабЧастиДокумента("ЕдиницаИзмерения", МетаданныеДокумента, ИмяТабличнойЧасти) Тогда				
				...
				Если ЗначениеЗаполнено(ЕдиницаИзмерения) Тогда				
					Если ЕдиницаИзмерения.Владелец <> СтрокаТабличнойЧасти.Номенклатура Тогда				
						ВызватьИсключение НСтр("ru='Табличная часть ""';uk='Таблична частина ""'") + ИмяТабличнойЧасти + НСтр("ru='"": в строке ';uk='"": у рядку '") + (Индекс + 1) + НСтр("ru=' единица измерения не соответствует товару.';uk=' одиниця виміру не відповідає товару.'");						
					КонецЕсли;  
				Иначе			
			...
			Если ОбщегоНазначения.ЕстьРеквизитТабЧастиДокумента("ХарактеристикаНоменклатуры", МетаданныеДокумента, ИмяТабличнойЧасти)
				...
				ВызватьИсключение НСтр("ru='Табличная часть ""';uk='Таблична частина ""'") + ИмяТабличнойЧасти + НСтр("ru='"": в строке ';uk='"": у рядку '") + (Индекс + 1) + НСтр("ru=' характеристика не соответствует товару.';uk=' характеристика не відповідає товару.'");
			КонецЕсли; 	
			...
			Если ОбщегоНазначения.ЕстьРеквизитТабЧастиДокумента("СерияНоменклатуры", МетаданныеДокумента, ИмяТабличнойЧасти)
				...
				ВызватьИсключение НСтр("ru='Табличная часть ""';uk='Таблична частина ""'") + ИмяТабличнойЧасти + НСтр("ru='"": в строке ';uk='"": у рядку '") + (Индекс + 1) + НСтр("ru=' серия не соответствует товару.';uk=' серія не відповідає товару.'");
			КонецЕсли; 	
