...
Функция ПолучитьФильтрФайлов() Экспорт
	...
	Возврат НСтр("ru='Все файлы (*.*)|*.*|';uk='Всі файли (*.*)|*.*|'")
	      ...
	      + НСтр("ru='Письмо электронной почты (*.msg)|*.msg|';uk='Лист електронної пошти (*.msg)|*.msg|'")
	      + НСтр("ru='Картинки (*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf)|*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf|';uk='Картинки (*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf)|*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf|'")
	      + НСтр("ru='Текстовый документ (*.txt)|*.txt|';uk='Текстовий документ (*.txt)|*.txt|'")
	      + НСтр("ru='Табличный документ (*.mxl)|*.mxl|';uk='Табличний документ (*.mxl)|*.mxl|'");
...
Функция ПолучитьФильтрИзображений() Экспорт
	...
	Возврат НСтр("ru='Все картинки (*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf)|*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf|';uk='Всі картинки (*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf)|*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.tif;*.gif;*.png;*.ico;*.wmf;*.emf|'") 
...
Функция ВыбратьКаталог(ИмяКаталога, Знач ЗаголовокДиалога = "Укажите каталог") Экспорт
	...
	Если ЗаголовокДиалога = "Укажите каталог" Тогда
		ЗаголовокДиалога = НСтр("ru='Укажите каталог';uk='Вкажіть каталог'");
	КонецЕсли; 
