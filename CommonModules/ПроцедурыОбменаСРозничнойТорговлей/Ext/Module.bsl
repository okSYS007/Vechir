...
Функция ПолучитьМассивВсехУзлов() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ различные
	               |	ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.Ссылка КАК Ссылка
	               |ИЗ
	...
	Запрос.УстановитьПараметр("ЭтотУзел", ПланыОбмена.ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.ЭтотУзел());			   
...
Функция ПолучитьТаблицуУзловИДат() Экспорт
	...
	Хранилище = ПараметрыСеанса.СоответствиеУзловИДатДляОбменаУправлениеТорговымПредприятиемРозничнаяТорговля;
...
Функция ПолучитьЗапросомМассивУзловПоТипуЦен(ТипЦеныНоменклатуры) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ОбменУправлениеТорговымПредприятиемРозничнаяТорговляТипыЦенНоменклатуры.Ссылка
	|ИЗ
	|	ПланОбмена.ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.ТипыЦенНоменклатуры КАК ОбменУправлениеТорговымПредприятиемРозничнаяТорговляТипыЦенНоменклатуры
	|ГДЕ
	|	ОбменУправлениеТорговымПредприятиемРозничнаяТорговляТипыЦенНоменклатуры.ТипЦеныНоменклатуры = &ТипЦеныНоменклатуры
	|	И ОбменУправлениеТорговымПредприятиемРозничнаяТорговляТипыЦенНоменклатуры.Ссылка <> &ЭтотУзел
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ИЗ
	|	ПланОбмена.ОбменУправлениеТорговымПредприятиемРозничнаяТорговля КАК ОбменУправлениеТорговымПредприятиемРозничнаяТорговля
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПланОбмена.ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.ТипыЦенНоменклатуры КАК ОбменУправлениеТорговымПредприятиемРозничнаяТорговляТипыЦенНоменклатуры
	|		ПО (ОбменУправлениеТорговымПредприятиемРозничнаяТорговляТипыЦенНоменклатуры.Ссылка = ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.Ссылка)
	|ГДЕ
	|	ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.Ссылка <> &ЭтотУзел
	|
	|СГРУППИРОВАТЬ ПО
	...
	|
	|ИМЕЮЩИЕ
	|	КОЛИЧЕСТВО(ОбменУправлениеТорговымПредприятиемРозничнаяТорговляТипыЦенНоменклатуры.ТипЦеныНоменклатуры) = 0";
...
Функция ПолучитьЗапросомМассивУзловПоСкладу(Склад) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.Ссылка
	|ИЗ
	|	ПланОбмена.ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.СоответствияМагазиновИСкладов КАК ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов
	|ГДЕ
	|	(ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.СкладМагазина = &Склад
	|			ИЛИ ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.СкладМагазина ЕСТЬ NULL )
	|	И ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.Ссылка <> &ЭтотУзел";
...
Функция ПолучитьЗапросомМассивУзловПоКассе(Касса) Экспорт
	...
	|	ПланОбмена.ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.СоответствияМагазиновИСкладов КАК ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов
	|ГДЕ
	|	(ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.КассаМагазина = &Касса
	|			ИЛИ ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.КассаМагазина ЕСТЬ NULL )
	|	И ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.Ссылка <> &ЭтотУзел";
...
Функция ПолучитьЗапросомМассивУзловПоКассеККМ(КассаККМ) Экспорт
	...
	|	ПланОбмена.ОбменУправлениеТорговымПредприятиемРозничнаяТорговля.СоответствияМагазиновИСкладов КАК ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов
	|ГДЕ
	|	(ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.КассаККММагазина = &КассаККМ
	|			ИЛИ ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.КассаККММагазина ЕСТЬ NULL )
	|	И ОбменУправлениеТорговымПредприятиемРозничнаяТорговляСоответствияМагазиновИСкладов.Ссылка <> &ЭтотУзел";
...
Процедура ЗарегистрироватьИзмененияДляСебестоимости(УзелОбменаОбъект) Экспорт
	...
	ТекстЗапроса =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	НАЧАЛОПЕРИОДА(ПродажиСебестоимость.Период, ДЕНЬ) КАК Период
	|ИЗ
