...
Процедура ПроверитьЗаполнениеТабличнойЧастиТовары(ТаблицаПоТоварам, СтруктураШапкиДокумента, Отказ, Заголовок)
	...
	Для каждого СтрокаТаблицы Из ТаблицаПоТоварам Цикл
		...
		Если НЕ ЗначениеЗаполнено(СтрокаТаблицы.СпособОпределенияЗначенияТочкиЗаказа) Тогда
			...
			ОбщегоНазначения.СообщитьОбОшибке(СтрокаНачалаСообщенияОбОшибке + НСтр("ru='не заполнен cпособ определения значения точки заказа.';uk='не заповнений спосіб визначення значення точки замовлення.'"), Отказ, Заголовок);
		...
		Иначе
			...
			Если СтрокаТаблицы.СпособОпределенияЗначенияТочкиЗаказа = Перечисления.СпособыОпределенияЗначенияТочкиЗаказа.Фиксированная Тогда
				...
				Если НЕ ЗначениеЗаполнено(СтрокаТаблицы.ЗначениеТочкиЗаказа) Тогда
					...
					ОбщегоНазначения.СообщитьОбОшибке(СтрокаНачалаСообщенияОбОшибке + НСтр("ru='не заполнено значение точки заказа.';uk='не заповнено значення точки замовлення.'"), Отказ, Заголовок);
			...
			ИначеЕсли СтрокаТаблицы.СпособОпределенияЗначенияТочкиЗаказа = Перечисления.СпособыОпределенияЗначенияТочкиЗаказа.СреднийРазмерПартии Тогда
				...
				Если НЕ ЗначениеЗаполнено(СтрокаТаблицы.ДатаНач) Тогда
					...
					ОбщегоНазначения.СообщитьОбОшибке(СтрокаНачалаСообщенияОбОшибке + НСтр("ru='не заполнено значение даты начала периода.';uk='не заповнено значення дати початку періоду.'"), Отказ, Заголовок);
				...
				Если НЕ ЗначениеЗаполнено(СтрокаТаблицы.ДатаКон) Тогда
					...
					ОбщегоНазначения.СообщитьОбОшибке(СтрокаНачалаСообщенияОбОшибке + НСтр("ru='не заполнено значение даты окончания периода.';uk='не заповнено значення дати закінчення періоду.'"), Отказ, Заголовок);
				...
				Если НЕ ЗначениеЗаполнено(СтрокаТаблицы.ПроцентнаяСтавкаЗначенияТочкиЗаказа) Тогда
					...
					ОбщегоНазначения.СообщитьОбОшибке(СтрокаНачалаСообщенияОбОшибке + НСтр("ru='не заполнено значение процентной ставка значения точки заказа.';uk='не заповнено значення процентної ставки значення точки замовлення.'"), Отказ, Заголовок);
