...
//
Функция ПодготовитьТаблицуПоЗаказамПокупателей()
	...
	Запрос.Текст = "
	|ВЫБРАТЬ
	|	ТаблицаЗаказов.ПричинаЗакрытияЗаказа КАК ПричинаЗакрытияЗаказа,
	...
	|ИЗ
	|	РегистрНакопления.ЗаказыПокупателей.Остатки(&МоментДокумента, ДоговорКонтрагента В (ВЫБРАТЬ РАЗЛИЧНЫЕ Заказ.ДоговорКонтрагента
	|                                                                  ИЗ Документ.ЗаказПоставщику КАК Заказ
	|                                                                  ГДЕ Заказ.Ссылка В (&СписокЗаказов))
	|                                                                И ЗаказПокупателя В (&СписокЗаказов)) КАК ЗаказыПокупателейОстатки
	|ЛЕВОЕ СОЕДИНЕНИЕ
	|	Документ.ЗакрытиеЗаказовПоставщикам.Заказы КАК ТаблицаЗаказов
	|ПО
	|	ТаблицаЗаказов.Ссылка = &ДокументСсылка
	|	И
	|	ТаблицаЗаказов.ЗаказПоставщику = ЗаказыПокупателейОстатки.ЗаказПокупателя
	|";
...
КонецФункции // ПодготовитьТаблицуПоЗаказамПокупателей()
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Не Отказ Тогда
		...
		ТаблицаПоЗаказамПокупателей = ПодготовитьТаблицуПоЗаказамПокупателей();
