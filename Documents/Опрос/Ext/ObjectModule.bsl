...
Процедура Печать(ИмяМакета, КоличествоЭкземпляров = 1, НаПринтер = Ложь) Экспорт
	...
	ИначеЕсли ИмяМакета = "HTML" Тогда
		...
		Если ТиповаяАнкета.Пустая() Тогда
			Сообщить(НСтр("ru='Не выбрана анкета!';uk='Не обрана анкета!'"));
			Возврат;
		КонецЕсли;
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	СтруктураМакетов.Вставить("Опрос",	НСтр("ru='Опрос';uk='Опитування'"));
	СтруктураМакетов.Вставить("HTML",	НСтр("ru='Просмотр HTML';uk='Перегляд HTML'"));
...
Функция ПроверитьОбязательноЗаполняемыеОтветы(ПоВопросу = Неопределено, НеПроверкаНаУсловноНеЗапольнять = Истина) Экспорт
	...
	Пока ВыборкаПоОбязательнымОтветам.Следующий() Цикл
		...
		Если ВыборкаПоОбязательнымОтветам.Обязательный = Перечисления.ОбязательностьЗаполненияОтветаНаВопрос.ОбязателенКЗаполнению тогда
			Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
				Если НеПроверкаНаУсловноНеЗапольнять Тогда
					Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос+НСтр("ru='"" должен быть обязательно заполнен';uk='"" обов''язково повинен бути заповнений'"));
				КонецЕсли;
				ЕстьОшибки = Истина;
			КонецЕсли;
		...
		Иначе
			Если ВыборкаПоОбязательнымОтветам.Обязательный = Перечисления.ОбязательностьЗаполненияОтветаНаВопрос.ОбязателенКЗаполнению Тогда
				ТекстОбязательности =  НСтр("ru='"" должен быть обязательно заполнен, если ';uk='"" обов''язково повинен бути заповнений, якщо '");
				
			Иначе
				ТекстОбязательности =  НСтр("ru='"" не должен заполнятся, если ';uk='"" не повинен заповняться, якщо '");
			...
			Если ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 0 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если НЕ ЗначениеЗаполнено(ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса) тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос+ ТекстОбязательности + НСтр("ru='не указан ответ на вопрос ""';uk='не вказана відповідь на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 1 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если ЗначениеЗаполнено(ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса) тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности + НСтр("ru='указан любой ответ на вопрос ""';uk='вказана будь-яка відповідь на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 2 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса = ВыборкаПоОбязательнымОтветам.ОтветУсловия тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности +НСтр("ru='указан ответ ';uk='вказана відповідь '") + ВыборкаПоОбязательнымОтветам.ОтветУсловия + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 3 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса <> ВыборкаПоОбязательнымОтветам.ОтветУсловия тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности +НСтр("ru='указан любой ответ, кроме ';uk='вказана будь-яка відповідь, крім '") + ВыборкаПоОбязательнымОтветам.ОтветУсловия + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 4 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса > ВыборкаПоОбязательнымОтветам.ОтветУсловия тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности + НСтр("ru='в качестве ответа указано значение больше, чем ';uk='в якості відповіді вказано значення більше, ніж '") + ВыборкаПоОбязательнымОтветам.ОтветУсловия + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 5 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса >= ВыборкаПоОбязательнымОтветам.ОтветУсловия тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности + НСтр("ru='в качестве ответа указано значение больше либо равное ';uk='в якості відповіді вказано значення більше або рівне '") + ВыборкаПоОбязательнымОтветам.ОтветУсловия + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 6 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса < ВыборкаПоОбязательнымОтветам.ОтветУсловия тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'")+ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности + НСтр("ru='в качестве ответа указано значение меньше, чем ';uk='в якості відповіді вказано значення менше, ніж '") + ВыборкаПоОбязательнымОтветам.ОтветУсловия + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 7 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					Если ВыборкаПоОбязательнымОтветам.ТиповойОтветУсловияВопроса <= ВыборкаПоОбязательнымОтветам.ОтветУсловия тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'") + ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности + НСтр("ru='в качестве ответа указано значение меньше либо равное ';uk='в якості відповіді вказано значення менше або рівне '") + ВыборкаПоОбязательнымОтветам.ОтветУсловия + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 8 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					...
					Если ЕстьВСписке тогда
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'") + ВыборкаПоОбязательнымОтветам.Вопрос + ТекстОбязательности +НСтр("ru='в качестве ответа указан один из вариантов ответа ';uk='в якості відповіді вказано один з варіантів відповіді '") + СтрокаЗначенийСписка + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					Иначе
						Продолжить;
			...
			ИначеЕсли ВыборкаПоОбязательнымОтветам.УсловиеОтвета = 9 тогда
				...
				Если УдовлетворяетУсловию(ВыборкаПоОбязательнымОтветам.Вопрос, ВыборкаПоОбязательнымОтветам.ТиповойОтвет,ВыборкаПоОбязательнымОтветам.Обязательный,НеПроверкаНаУсловноНеЗапольнять) тогда
					...
					Иначе
						Если НеПроверкаНаУсловноНеЗапольнять Тогда
							Сообщить(НСтр("ru='Ответ на вопрос ""';uk='Відповідь на питання ""'") + ВыборкаПоОбязательнымОтветам.Вопрос + НСтр("ru='"" должен быть обязательно заполнен, если в качестве ответа не указан ни один из вариантов ответа ';uk='"" обов''язково повинен бути заповнений, якщо в якості відповіді не вказаний жоден з варіантів відповіді '") + СтрокаЗначенийСписка + НСтр("ru=' на вопрос ""';uk=' на питання ""'")+ ВыборкаПоОбязательнымОтветам.ВопросУсловия + """");
						КонецЕсли;
						ЕстьОшибки = Истина;
					КонецЕсли;
				КонецЕсли;
...
Функция ПечатьОпрос()
	...
	Если МакетАнкеты = Неопределено Тогда
		...
		Если НЕ ЗначениеЗаполнено(ТиповаяАнкета) Тогда
			Сообщить(НСтр("ru='Документ не может быть распечатан. Выберите типовую анкету.';uk='Документ не може бути роздрукований. Виберіть типову анкету.'"));
	...
	ОбластьНомераДокумента.Текст	= НСтр("ru='Документ Опрос №';uk='Документ Опитування №'")+Номер;
		...
		Пока ВыборкаЗапросаПоВопросам.Следующий() Цикл
			...
			ИначеЕсли ВыборкаЗапросаПоВопросам.ВопросТипОтветаНаВопрос = Перечисления.ТипыОтветаНаВопросАнкеты.Табличный тогда
				...
				Пока ВыборкаЗапросаПоОтветам.Следующий() Цикл
					...
					Исключение
						ОбщегоНазначения.СообщитьОбОшибке(НСтр("ru='Набор вопросов в анкете и в документе ""Опрос"" различны! Не найден вопрос с кодом ';uk='Набір питань в анкеті і у документі ""Опитування"" різні! Не знайдено питання з кодом '") + ВыборкаЗапросаПоОтветам.КодВопроса);
					КонецПопытки;
				КонецЦикла;
