...
Функция ПечатьДокумента()
	...
	|	Лимит
	|ИЗ
	|	Документ.ИзменениеЛимитовВозвратнойТары.ВозвратнаяТара КАК ИзменениеЛимитовВозвратнойТары
	|
	|ГДЕ
	|	ИзменениеЛимитовВозвратнойТары.Ссылка = &ТекущийДокумент
	|
	...
	ОбластьМакета.Параметры.ТекстЗаголовкаЛимита = ?(Шапка.ВидОперации = Перечисления.ВидыОперацийИзменениеЛимитовВозвратнойТары.ЛимитПокупателю, НСтр("ru='Лимит покупателю';uk='Ліміт покупцю'",КодЯзыкаПечать), НСтр("ru='Лимит поставщика';uk='Ліміт постачальника'",КодЯзыкаПечать));
	Если ВыводитьКоды Тогда
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("ИзменениеЛимитовТары", НСтр("ru='Изменение лимитов тары';uk='Зміна лімітів тари'"));
...
Процедура ОбновитьСтруктуруПараметровДляПолученияДоговора() Экспорт
	...
	Иначе
		мСтруктураПараметровДляПолученияДоговора = Неопределено;
	КонецЕсли;
