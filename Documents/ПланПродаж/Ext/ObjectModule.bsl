...
Функция ПечатьПланаПродаж()
	...
	|	ПланПродаж.ВалютаДокумента.Наименование КАК ВалютаДокумента,
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='План продаж';uk='План продажів'",КодЯзыкаПечать),КодЯзыкаПечать);
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("ПланПродаж", НСтр("ru='План продаж';uk='План продажів'"));
