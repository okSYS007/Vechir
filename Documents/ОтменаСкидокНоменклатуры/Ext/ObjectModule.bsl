...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если ТаблицаПоДокументамНоменклатура.Количество() = 0
	   ...
	   ОбщегоНазначения.СообщитьОбОшибке(НСтр("ru='Не найдены движения по документам, указанным для отмены';uk='Не знайдено рухи по документам, вказаним для скасування'"), Отказ, Заголовок);
	КонецЕсли;
