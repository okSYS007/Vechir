...
Функция ФормаВыполненияЗадачи(Знач ЗадачаСсылка, Знач ТочкаМаршрутаСсылка) Экспорт
	...
	//Если ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеРеестраНаОплату.ТочкиМаршрута.ДиректорДепартамента
	//	Или ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеРеестраНаОплату.ТочкиМаршрута.ФинансовыйКонтролер
		если ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеРеестраНаОплату.ТочкиМаршрута.РуководительКомпании

		Тогда
		ИмяФормы = "БизнесПроцесс.СогласованиеРеестраНаОплату.Форма.ФормаЗадачиРецензента";
