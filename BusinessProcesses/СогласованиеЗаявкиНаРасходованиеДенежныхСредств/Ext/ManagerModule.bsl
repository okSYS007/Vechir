...
Функция ФормаВыполненияЗадачи(Знач ЗадачаСсылка, Знач ТочкаМаршрутаСсылка) Экспорт
	...
	Если ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.ТочкиМаршрута.ДиректорДепартамента
		Или ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.ТочкиМаршрута.ФинансовыйКонтролер
		//Дандали В. 24.07.2025 +
		//было БизнесПроцессы.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.ТочкиМаршрута.РуководительКомпании
		Или ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.ТочкиМаршрута.РуководительЦФО
		Или ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.ТочкиМаршрута.РуководительПроекта

		//Дандали В. 24.07.2025 -
		
		Тогда
		ИмяФормы = "БизнесПроцесс.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.Форма.ФормаЗадачиРецензента";
	//ИначеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.ТочкиМаршрута.ПодвестиИтогиСогласования Тогда
	//	ИмяФормы = "БизнесПроцесс.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.Форма.ФормаЗадачиПодвестиИтоги";
	КонецЕсли;
...
Функция РезультатСогласованияПоТочкеМаршрута(Знач БизнесПроцесс, Знач ТочкаМаршрута) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.РезультатСогласования КАК РезультатСогласования
	                      |ИЗ
	                      ...
	                      |ГДЕ
	                      |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.Ссылка = &Ссылка
	                      |	И СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.ТочкаМаршрута = &ТочкаМаршрута");
...
Функция НомерПоследнейВерсииПредмета(Знач БизнесПроцесс) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ ПЕРВЫЕ 1
	                      ...
	                      |ГДЕ
	                      |	ВерсииОбъектов.Объект = ВЫРАЗИТЬ(&БизнесПроцесс КАК БизнесПроцесс.СогласованиеЗаявкиНаРасходованиеДенежныхСредств).Предмет
	                      |
	                      |УПОРЯДОЧИТЬ ПО
	                      |	НомерВерсии УБЫВ");
...
Функция ПолучитьЗачаду(Заявка) Экспорт
	Запрос = новый запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ГДЕ
	               |	ЗадачаИсполнителяЗадачиПоИсполнителю.БизнесПроцесс.Предмет = &Ссылка
	               |	И НЕ ЗадачаИсполнителяЗадачиПоИсполнителю.Выполнена";
