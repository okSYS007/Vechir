...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВидЗаказчика", НСтр("ru='Вид заказчика';uk='Вид замовника'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Заказчик", НСтр("ru='Заказчик';uk='Замовник'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВнутреннийЗаказ", НСтр("ru='Заказ';uk='Замовлення'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЕдиницаИзмерения", НСтр("ru='Единица заказа';uk='Одиниця замовлення'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Запланировано",      НСтр("ru='Запланировано отгрузить';uk='Заплановано відвантажити'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОтгрузить",  НСтр("ru='Осталось выполнить';uk='Залишилося виконати'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СоСклада",           НСтр("ru='Зарезервировано на складе';uk='Зарезервовано на складі'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Заказано",           НСтр("ru='Размещено в заказах';uk='Розміщено в замовленнях'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОбеспечить", НСтр("ru='Осталось обеспечить';uk='Залишилося забезпечити'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОтгрузитьБазовыхЕд",  НСтр("ru='Осталось выполнить (в базовых ед.)';uk='Залишилося виконати (в базових од.)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СоСкладаБазовыхЕд",           НСтр("ru='Зарезервировано на складе (в базовых ед.)';uk='Зарезервовано на складі (у базових од.)'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОтгрузитьЕдиницОтчетов",  НСтр("ru='Осталось выполнить (в ед. отчетов)';uk='Залишилося виконати (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СоСкладаЕдиницОтчетов",           НСтр("ru='Зарезервировано на складе (в ед. отчетов)';uk='Зарезервовано на складі (в од. звітів)'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗапланированоЕдиницЗаказа",      НСтр("ru='Запланировано отгрузить (в ед. заказа)';uk='Заплановано відвантажити (в од. замовлення)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОтгрузитьЕдиницЗаказа",  НСтр("ru='Осталось выполнить (в ед. заказа)';uk='Залишилося виконати (в од. замовлення)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СоСкладаЕдиницЗаказа",           НСтр("ru='Зарезервировано на складе (в ед. заказа)';uk='Зарезервовано на складі (в од. замовлення)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗаказаноЕдиницЗаказа",           НСтр("ru='Размещено в заказах (в ед. заказа)';uk='Розміщено в замовленнях (в од. замовлення)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОбеспечитьЕдиницЗаказа", НСтр("ru='Осталось обеспечить (в ед. заказа)';uk='Залишилося забезпечити (в од. замовлення)'"));
	
	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	
	УниверсальныйОтчет.ДобавитьПоказатель("Запланировано",      НСтр("ru='Запланировано отгрузить';uk='Заплановано відвантажити'"),  Истина, "ЧЦ=15; ЧДЦ=3", "Выполнение", НСтр("ru='Выполнение (в ед. хранения)';uk='Виконання (в од. зберігання)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОтгрузить",  НСтр("ru='Осталось выполнить';uk='Залишилося виконати'"),  		Истина, "ЧЦ=15; ЧДЦ=3", "Выполнение", НСтр("ru='Выполнение (в ед. хранения)';uk='Виконання (в од. зберігання)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СоСклада",           НСтр("ru='Зарезервировано на складе';uk='Зарезервовано на складі'"),Истина, "ЧЦ=15; ЧДЦ=3", "Выполнение", НСтр("ru='Выполнение (в ед. хранения)';uk='Виконання (в од. зберігання)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("Заказано",           НСтр("ru='Размещено в заказах';uk='Розміщено в замовленнях'"),      Истина, "ЧЦ=15; ЧДЦ=3", "Выполнение", НСтр("ru='Выполнение (в ед. хранения)';uk='Виконання (в од. зберігання)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОбеспечить", НСтр("ru='Осталось обеспечить';uk='Залишилося забезпечити'"), 		Истина, "ЧЦ=15; ЧДЦ=3", "Выполнение", НСтр("ru='Выполнение (в ед. хранения)';uk='Виконання (в од. зберігання)'"));
	
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоБазовыхЕд",      НСтр("ru='Запланировано отгрузить';uk='Заплановано відвантажити'"),     Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеБазовыхЕд", НСтр("ru='Выполнение (в базовых ед.)';uk='Виконання (у базових од.)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОтгрузитьБазовыхЕд",  НСтр("ru='Осталось выполнить';uk='Залишилося виконати'"),  		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеБазовыхЕд", НСтр("ru='Выполнение (в базовых ед.)';uk='Виконання (у базових од.)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СоСкладаБазовыхЕд",           НСтр("ru='Зарезервировано на складе';uk='Зарезервовано на складі'"),   Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеБазовыхЕд", НСтр("ru='Выполнение (в базовых ед.)';uk='Виконання (у базових од.)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноБазовыхЕд",           НСтр("ru='Размещено в заказах';uk='Розміщено в замовленнях'"),         Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеБазовыхЕд", НСтр("ru='Выполнение (в базовых ед.)';uk='Виконання (у базових од.)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОбеспечитьБазовыхЕд", НСтр("ru='Осталось обеспечить';uk='Залишилося забезпечити'"), 		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеБазовыхЕд", НСтр("ru='Выполнение (в базовых ед.)';uk='Виконання (у базових од.)'"));
	
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоЕдиницОтчетов",      НСтр("ru='Запланировано отгрузить';uk='Заплановано відвантажити'"),		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницОтчетов", НСтр("ru='Выполнение (в ед. отчетов)';uk='Виконання (в од. звітів)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОтгрузитьЕдиницОтчетов",  НСтр("ru='Осталось выполнить';uk='Залишилося виконати'"),   		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницОтчетов", НСтр("ru='Выполнение (в ед. отчетов)';uk='Виконання (в од. звітів)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СоСкладаЕдиницОтчетов",           НСтр("ru='Зарезервировано на складе';uk='Зарезервовано на складі'"),   Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницОтчетов", НСтр("ru='Выполнение (в ед. отчетов)';uk='Виконання (в од. звітів)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноЕдиницОтчетов",           НСтр("ru='Размещено в заказах';uk='Розміщено в замовленнях'"),   		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницОтчетов", НСтр("ru='Выполнение (в ед. отчетов)';uk='Виконання (в од. звітів)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОбеспечитьЕдиницОтчетов", НСтр("ru='Осталось обеспечить';uk='Залишилося забезпечити'"),  		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницОтчетов", НСтр("ru='Выполнение (в ед. отчетов)';uk='Виконання (в од. звітів)'"));
	
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоЕдиницЗаказа",      НСтр("ru='Запланировано отгрузить';uk='Заплановано відвантажити'"), 		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницЗаказа", НСтр("ru='Выполнение (в ед. заказа)';uk='Виконання (в од. замовлення)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОтгрузитьЕдиницЗаказа",  НСтр("ru='Осталось выполнить';uk='Залишилося виконати'"),   		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницЗаказа", НСтр("ru='Выполнение (в ед. заказа)';uk='Виконання (в од. замовлення)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СоСкладаЕдиницЗаказа",           НСтр("ru='Зарезервировано на складе';uk='Зарезервовано на складі'"),    Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницЗаказа", НСтр("ru='Выполнение (в ед. заказа)';uk='Виконання (в од. замовлення)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноЕдиницЗаказа",           НСтр("ru='Размещено в заказах';uk='Розміщено в замовленнях'"),     		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницЗаказа", НСтр("ru='Выполнение (в ед. заказа)';uk='Виконання (в од. замовлення)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОбеспечитьЕдиницЗаказа", НСтр("ru='Осталось обеспечить';uk='Залишилося забезпечити'"),  		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницЗаказа", НСтр("ru='Выполнение (в ед. заказа)';uk='Виконання (в од. замовлення)'"));
