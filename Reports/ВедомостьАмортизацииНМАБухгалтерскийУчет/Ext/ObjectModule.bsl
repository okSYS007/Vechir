...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ПостроительОтчета.ВыбранныеПоля.Добавить(НСтр("ru='СпособНачисленияАмортизации';uk='СпособНачисленияАмортизации'"));
...
ОбщийОтчет.мНазваниеОтчета      = НСтр("ru='Ведомость по амортизации НМА (бухгалтерский учет)';uk='Відомість по амортизації НМА (бухгалтерський облік)'");
