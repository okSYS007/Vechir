...
Функция СформироватьЗаголовок() Экспорт
	...
	ТекстСписокПоказателей = НСтр("ru='Выводимые данные: сумма';uk='Виведені дані: сума'", КодЯзыкаПечать);
	
	Если ПоВалютам Тогда
		ТекстСписокПоказателей = ТекстСписокПоказателей + НСтр("ru=', валютная сумма';uk=', валютна сума'", КодЯзыкаПечать);
	КонецЕсли;
...
Функция ЗаголовокОтчета() Экспорт
	Возврат НСтр("ru='Шахматная оборотная ведомость';uk='Шахова оборотна відомість'", ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов());
