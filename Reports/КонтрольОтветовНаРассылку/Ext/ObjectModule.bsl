...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов() = "uk" Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, """Не приславшие ответ""", """Не надіслали відповідь""");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, """Приславшие ответ""", """Надіслали відповідь""");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, """Прочие""", """Інші""");
	КонецЕсли;
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ФормированиеАнкетПолучатели.Объект" , "Объект", НСтр("ru='Опрашиваемое лицо';uk='Особа, яку опитуюсь'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ФизическиеЛица);
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Объект", 			НСтр("ru='Опрашиваемое лицо';uk='Особа, яку опитуюсь'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Получатель", 		"e-mail");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Ссылка", 			НСтр("ru='Опрос';uk='Опитування'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("НаличиеОтвета", 	НСтр("ru='Наличие ответа';uk='Наявність відповіді'"));
