...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	|" 			+ НСтр("ru='""Заказ поставщику""';uk='""Замовлення постачальнику""'", ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов()) + " 
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ПричиныЗакрытияЗаказов.ДоговорКонтрагента",  "ДоговорКонтрагента",   НСтр("ru='Договор контрагента';uk='Договір контрагента'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ДоговорыКонтрагентов);
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ПричиныЗакрытияЗаказов.Заказ",             	"Заказ",            	НСтр("ru='Заказ';uk='Замовлення'"),               ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Документы);
        УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ПричиныЗакрытияЗаказов.Заказ",             	"Заказ",            	НСтр("ru='Заказ';uk='Замовлення'"),               ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Документ_ЗаказПокупателя);
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПричинаЗакрытияЗаказа",   НСтр("ru='Причина закрытия заказа';uk='Причина закриття замовлення'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВалютаДокумента", 		НСтр("ru='Валюта документа';uk='Валюта документа'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаЗаказа",      	 НСтр("ru='Сумма заказа';uk='Сума замовлення'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КурсВзаиморасчетов",   НСтр("ru='Курс взаиморасчетов';uk='Курс взаєморозрахунків'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВидЗаказа",            НСтр("ru='Вид заказа';uk='Вид замовлення'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаУпрУчета",        НСтр("ru='Сумма упр. учета';uk='Сума упр. обліку'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетов",  НСтр("ru='Сумма взаиморасчетов';uk='Сума взаєморозрахунків'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОтветственныйЗаЗаказ", НСтр("ru='Ответственный за заказ';uk='Відповідальний за замовлення'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОтветственныйЗаЗакрытиеЗаказа", НСтр("ru='Ответственный за закрытие заказа';uk='Відповідальний за закриття замовлення'"));
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаУпрУчета",        НСтр("ru='Сумма упр. учета';uk='Сума упр. обліку'"),     Истина, "ЧЦ=15; ЧДЦ=2", "СуммаЗакрытияЗаказа", НСтр("ru='Сумма закрытия заказа';uk='Сума закриття замовлення'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетов",  НСтр("ru='Сумма взаиморасчетов';uk='Сума взаєморозрахунків'"), Истина, "ЧЦ=15; ЧДЦ=2", "СуммаЗакрытияЗаказа", НСтр("ru='Сумма закрытия заказа';uk='Сума закриття замовлення'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаЗаказа",          НСтр("ru='Сумма заказа';uk='Сума замовлення'"),         Истина, "ЧЦ=15; ЧДЦ=2");
...
Процедура СформироватьОтчет(ТабличныйДокумент) Экспорт
	Если НЕ (ЗаказыПокупателей ИЛИ ЗаказыПоставщикам ) Тогда
		Сообщить(НСтр("ru='Должен быть выбран хотя бы один вид заказа. Отчет не сформирован.';uk='Повинен бути вибраний хоча б один вид замовлення. Звіт не сформований.'"));
		Возврат;
	КонецЕсли;
