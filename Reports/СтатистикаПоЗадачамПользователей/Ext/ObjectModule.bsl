...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("БизнесПроцесс",  НСтр("ru='Бизнес-процесс';uk='Бізнес-процес'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ТочкаМаршрута",  НСтр("ru='Точка маршрута';uk='Точка маршруту'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПросроченоДней", НСтр("ru='Просрочено (дней)';uk='Прострочено (днів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СрокИсполнения", НСтр("ru='Срок исполнения';uk='Строк виконання'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДатаВыполнения", НСтр("ru='Дата исполнения';uk='Дата виконання'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Задача",         НСтр("ru='Задача пользователя';uk='Задача користувача'"));
    	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоЗадач"      , НСтр("ru='Всего задач';uk='Всього задач'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоВыполненных", НСтр("ru='Всего выполнено';uk='Всього виконано'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоПросроченныхВыполненных", НСтр("ru='Выполнено просрочено';uk='Виконано прострочено'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоНеПросроченныхВыполненных", НСтр("ru='Выполнено не просрочено';uk='Виконано не прострочено'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоНеВыполненных",               НСтр("ru='Всего не выполнено';uk='Всього не виконано'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоПросроченныхНеВыполненных",   НСтр("ru='Не выполнено просрочено';uk='Не виконано прострочено'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоНеПросроченныхНеВыполненных", НСтр("ru='Не выполнено не просрочено';uk='Не виконано не прострочено'"));
