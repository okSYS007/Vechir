...
НоваяФорма.ДатаКонецДействия  = '20120229' ;

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2012Кв2";
НоваяФорма.ОписаниеОтчета     = НСтр("ru = 'Утверждена Приказом Министерства финансов Украины 25.11.11  № 1492 (с изм. по Приказу №143 от 10.02.2012)'; uk = 'Затверджено Наказом Міністерства фінансів України 25.11.2011 p. № 1492 (зі змінами за Наказом №143 від 10.02.2012)'");
НоваяФорма.ДатаНачалоДействия = '20120301';
