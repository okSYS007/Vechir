...
Функция ПолучитьСписокВариантовОтображенияОтчета() Экспорт
	...
	СписокВариантовОтображения.Добавить(Перечисления.ВариантыОтображенияОтчетов.СводнаяТаблица,НСтр("ru='Сводная таблица';uk='Зведена таблиця'"));
...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ОбщийОтчет.мНазваниеОтчета = НСтр("ru='Ответы на вопрос';uk='Відповіді на питання'");
	ОтчетДиаграмма.ИмяРегистра = "-";
	ОтчетДиаграмма.мНазваниеОтчета = НСтр("ru='Ответы на вопрос';uk='Відповіді на питання'");
