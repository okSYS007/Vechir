...
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к Положению (стандарту) бухгалтерского учета № 2 (с изменениями, внесенными приказом Министерства финансов Украины № 1591 от 09.12.2011 г.)'; uk = 'Додаток до Положення (стандарту) бухгалтерського обліку № 2 (зі змінами, внесеними наказом Міністерства фінансів України № 1591 від 09.12.2011 р.)'");
