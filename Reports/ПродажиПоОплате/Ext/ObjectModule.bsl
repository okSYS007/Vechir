...
// в течение периода отчета.
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаПродажи",          НСтр("ru='Сумма продажи';uk='Сума продажу'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоОборот",      НСтр("ru='Количество (в ед. хранения)';uk='Кількість (в од. зберігання)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоЕдиницДляОтчетовОборот", НСтр("ru='Количество (в ед. отчетов)';uk='Кількість (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Себестоимость",         НСтр("ru='Стоимость';uk='Вартість'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Маржа",                 НСтр("ru='Прибыль';uk='Прибуток'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаЗатрат",           НСтр("ru='Сумма затрат';uk='Сума витрат'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЧистаяМаржа",           НСтр("ru='Чистая прибыль';uk='Чистий прибуток'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПлановаяСебестоимость", НСтр("ru='Плановая себестоимость';uk='Планова собівартість'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПлановаяПрибыль",       НСтр("ru='Плановая прибыль';uk='Плановий прибуток'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДоговорВзаиморасчетовПокупателя", НСтр("ru='Договор с покупателем';uk='Договір з покупцем'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗаказПокупателя",                 НСтр("ru='Заказ покупателя';uk='Замовлення покупця'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументРеализации",              НСтр("ru='Регистратор (Документ реализации)';uk='Реєстратор (Документ реалізації)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументОприходования",           НСтр("ru='Документ поставки';uk='Документ поставки'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Ответственный",                   НСтр("ru='Основной менеджер контрагента';uk='Основний менеджер контрагента'"));
	
	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаПродажи",          НСтр("ru='Сумма продажи';uk='Сума продажу'"),          Истина, "ЧЦ=15; ЧДЦ=2");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоЕдиницДляОтчетовОборот", НСтр("ru='Количество (в ед. отчетов)';uk='Кількість (в од. звітів)'"), Ложь, "ЧЦ=15; ЧДЦ=3");
	УниверсальныйОтчет.ДобавитьПоказатель("Себестоимость",         НСтр("ru='Стоимость';uk='Вартість'"),              Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("Маржа",                 НСтр("ru='Прибыль';uk='Прибуток'"),                Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаЗатрат",           НСтр("ru='Сумма затрат';uk='Сума витрат'"),           Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ЧистаяМаржа",           НСтр("ru='Чистая прибыль';uk='Чистий прибуток'"),         Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ПлановаяСебестоимость", НСтр("ru='Плановая себестоимость';uk='Планова собівартість'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ПлановаяПрибыль",       НСтр("ru='Плановая прибыль';uk='Плановий прибуток'"),       Истина, "ЧЦ=15; ЧДЦ=2");
...
Процедура СформироватьОтчет(ТабличныйДокумент) Экспорт
	...
	Если Не ЗначениеЗаполнено(УниверсальныйОтчет.ДатаНач)
	 ИЛИ Не ЗначениеЗаполнено(УниверсальныйОтчет.ДатаКон) Тогда
		Предупреждение(НСтр("ru='Не задан период отчета!';uk='Не заданий період звіту!'"));
		Возврат;
	КонецЕсли;
