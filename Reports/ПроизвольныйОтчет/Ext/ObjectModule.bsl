...
Функция СформироватьОтчет(Результат = Неопределено, ДанныеРасшифровки = Неопределено, ВыводВФормуОтчета = Истина) Экспорт
	...
	Если ПроизвольныйОтчет.Пустая() Тогда 
		ОбщегоНазначения.СообщитьОбОшибке(НСтр("ru='Не выбран произвольный отчет.';uk='Не вибраний довільний звіт.'"));
		Возврат Ложь;
	КонецЕсли;
	...
	Исключение
		...
		#Если Клиент Тогда
		Вопрос(НСтр("ru='Отчет не сформирован';uk='Звіт не сформований'") + Символы.ПС + ПричинаОшибки, РежимДиалогаВопрос.ОК);
		#Иначе
		ОбщегоНазначения.Сообщение(НСтр("ru='Отчет не сформирован: ';uk='Звіт не сформований: '") + ПроизвольныйОтчет + Символы.ПС + ПричинаОшибки);
		#КонецЕсли
	КонецПопытки;
