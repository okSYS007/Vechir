...
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Версия с 2015 г.';uk='Версія з 2015 р.'");
НоваяФорма.ДатаНачалоДействия = '20150101';
НоваяФорма.ДатаКонецДействия  = '20160831';
...
НоваяФорма.ДатаНачалоДействия = '20160901';
...
НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2019м9";
