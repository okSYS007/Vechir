...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ФизЛицо", НСтр("ru='Опрашиваемое лицо';uk='Особа, яку опитуюсь'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДатаАнкетирования", НСтр("ru='Дата опроса';uk='Дата опитування'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ТиповойОтвет", НСтр("ru='Типовой ответ';uk='Типова відповідь'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОценкаОтвета", НСтр("ru='Оценка ответа';uk='Оцінка відповіді'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВесВопроса", НСтр("ru='Вес вопроса';uk='Вага питання'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("АбсолютнаяОценка", НСтр("ru='Абсолютная оценка';uk='Абсолютна оцінка'"));
