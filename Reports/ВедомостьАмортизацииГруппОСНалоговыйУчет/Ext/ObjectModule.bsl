...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	СтруктураПредставлениеПолей.Вставить( "СтоимостьСАмортизациейОборот",   НСтр("ru='Изменение стоимости ОС с уч. аморт.';uk='Зміна вартості ОЗ із ур. аморт.'"));
	...
	ОбщийОтчет.ЗаполнитьПоказатели( "СтоимостьСАмортизациейОборот",   НСтр("ru='Изменение стоимости ОС с уч. аморт.';uk='Зміна вартості ОЗ із ур. аморт.'"), Истина, "ЧЦ=15; ЧДЦ=2");
...
ОбщийОтчет.мНазваниеОтчета = НСтр("ru='Ведомость амортизации групп ОС (налоговый учет)';uk='Відомість амортизації груп ОЗ (податковий облік)'");
