...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Состояние", НСтр("ru='Состояние';uk='Стан'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗначениеТочкиЗаказа", НСтр("ru='Значение точки заказа (ед. хранения)';uk='Значення точки замовлення (од. зберігання)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗначениеТочкиЗаказаЕдиницОтчетов", НСтр("ru='Значение точки заказа (в ед. отчетов)';uk='Значення точки замовлення (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗначениеТочкиЗаказаБазовыхЕдиниц", НСтр("ru='Значение точки заказа (базовых ед.)';uk='Значення точки замовлення (базових од.)'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("МинимальныйСтраховойЗапас", НСтр("ru='Минимальный страховой запас (ед. хранения)';uk='Мінімальний страховий запас (од. зберігання)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("МинимальныйСтраховойЗапасЕдиницОтчетов", НСтр("ru='Минимальный страховой запас (в ед. отчетов)';uk='Мінімальний страховий запас (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("МинимальныйСтраховойЗапасБазовыхЕдиниц", НСтр("ru='Минимальный страховой запас (базовых ед.)';uk='Мінімальний страховий запас (базових од.)'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Остаток", НСтр("ru='Остаток (ед. хранения)';uk='Залишок (од. зберігання)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОстатокЕдиницОтчетов", НСтр("ru='Остаток (в ед. отчетов)';uk='Залишок (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОстатокБазовыхЕдиниц", НСтр("ru='Остаток (базовых ед.)';uk='Залишок (базових од.)'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПросроченноеПоступление", НСтр("ru='Просроченное поступление (ед. хранения)';uk='Прострочене надходження (од. зберігання)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПросроченноеПоступлениеЕдиницОтчетов", НСтр("ru='Просроченное поступление (в ед. отчетов)';uk='Прострочене надходження (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПросроченноеПоступлениеБазовыхЕдиниц", НСтр("ru='Просроченное поступление (базовых ед.)';uk='Прострочене надходження (базових од.)'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОжидаемоеПоступление", НСтр("ru='Ожидаемое поступление (ед. хранения)';uk='Очікуване надходження (од. зберігання)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОжидаемоеПоступлениеЕдиницОтчетов", НСтр("ru='Ожидаемое поступление (в ед. отчетов)';uk='Очікуване надходження (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОжидаемоеПоступлениеБазовыхЕдиниц", НСтр("ru='Ожидаемое поступление (базовых ед.)';uk='Очікуване надходження (базових од.)'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РекомендуемыйОбъемЗакупки", НСтр("ru='Рекомендуемый объем закупки (ед. хранения)';uk='Рекомендований обсяг купівлі (од. зберігання)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РекомендуемыйОбъемЗакупкиЕдиницОтчетов", НСтр("ru='Рекомендуемый объем закупки (в ед. отчетов)';uk='Рекомендований обсяг купівлі (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РекомендуемыйОбъемЗакупкиБазовыхЕдиниц", НСтр("ru='Рекомендуемый объем закупки (базовых ед.)';uk='Рекомендований обсяг купівлі (базових од.)'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СрокДоставки", НСтр("ru='Срок доставки (в днях)';uk='Строк доставки (в днях)'"));
	
	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	УниверсальныйОтчет.ДобавитьПоказатель("ЗначениеТочкиЗаказа", НСтр("ru='Ед. хранения';uk='Од. зберігання'"), Истина, "ЧЦ=15; ЧДЦ=3", "ЗначениеТочкиЗаказа", "Значение" + Символы.ПС + НСтр("ru='точки заказа';uk='точки замовлення'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЗначениеТочкиЗаказаБазовыхЕдиниц", НСтр("ru='Базовых ед.';uk='Базових од.'"), Ложь, "ЧЦ=15; ЧДЦ=3", "ЗначениеТочкиЗаказа");
	УниверсальныйОтчет.ДобавитьПоказатель("ЗначениеТочкиЗаказаЕдиницОтчетов", НСтр("ru='Ед. отчетов';uk='Од. звітів'"), Ложь, "ЧЦ=15; ЧДЦ=3", "ЗначениеТочкиЗаказа");
	
	УниверсальныйОтчет.ДобавитьПоказатель("МинимальныйСтраховойЗапас", НСтр("ru='Ед. хранения';uk='Од. зберігання'"), Истина, "ЧЦ=15; ЧДЦ=3", "МинимальныйСтраховойЗапас", "Минимальный" + Символы.ПС + НСтр("ru='страховой запас';uk='страховий запас'"));
	УниверсальныйОтчет.ДобавитьПоказатель("МинимальныйСтраховойЗапасБазовыхЕдиниц", НСтр("ru='Базовых ед.';uk='Базових од.'"), Ложь, "ЧЦ=15; ЧДЦ=3", "МинимальныйСтраховойЗапас");
	УниверсальныйОтчет.ДобавитьПоказатель("МинимальныйСтраховойЗапасЕдиницОтчетов", НСтр("ru='Ед. отчетов';uk='Од. звітів'"), Ложь, "ЧЦ=15; ЧДЦ=3", "МинимальныйСтраховойЗапас");
	
	УниверсальныйОтчет.ДобавитьПоказатель("Остаток", НСтр("ru='Ед. хранения';uk='Од. зберігання'"), Истина, "ЧЦ=15; ЧДЦ=3", "Остаток", "Остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("ОстатокБазовыхЕдиниц", НСтр("ru='Базовых ед.';uk='Базових од.'"), Ложь, "ЧЦ=15; ЧДЦ=3", "Остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("ОстатокЕдиницОтчетов", НСтр("ru='Ед. отчетов';uk='Од. звітів'"), Ложь, "ЧЦ=15; ЧДЦ=3", "Остаток");
	
	УниверсальныйОтчет.ДобавитьПоказатель("ПросроченноеПоступление", НСтр("ru='Ед. хранения';uk='Од. зберігання'"), Истина, "ЧЦ=15; ЧДЦ=3", "ПросроченноеПоступление", "Просроченное" + Символы.ПС + "поступление");
	УниверсальныйОтчет.ДобавитьПоказатель("ПросроченноеПоступлениеБазовыхЕдиниц", НСтр("ru='Базовых ед.';uk='Базових од.'"), Ложь, "ЧЦ=15; ЧДЦ=3", "ПросроченноеПоступление");
	УниверсальныйОтчет.ДобавитьПоказатель("ПросроченноеПоступлениеЕдиницОтчетов", НСтр("ru='Ед. отчетов';uk='Од. звітів'"), Ложь, "ЧЦ=15; ЧДЦ=3", "ПросроченноеПоступление");
	
	УниверсальныйОтчет.ДобавитьПоказатель("ОжидаемоеПоступление", НСтр("ru='Ед. хранения';uk='Од. зберігання'"), Истина, "ЧЦ=15; ЧДЦ=3", "ОжидаемоеПоступление", "Ожидаемое" + Символы.ПС + "поступление");
	УниверсальныйОтчет.ДобавитьПоказатель("ОжидаемоеПоступлениеБазовыхЕдиниц", НСтр("ru='Базовых ед.';uk='Базових од.'"), Ложь, "ЧЦ=15; ЧДЦ=3", "ОжидаемоеПоступление");
	УниверсальныйОтчет.ДобавитьПоказатель("ОжидаемоеПоступлениеЕдиницОтчетов", НСтр("ru='Ед. отчетов';uk='Од. звітів'"), Ложь, "ЧЦ=15; ЧДЦ=3", "ОжидаемоеПоступление");
	
	УниверсальныйОтчет.ДобавитьПоказатель("РекомендуемыйОбъемЗакупки", НСтр("ru='Ед. хранения';uk='Од. зберігання'"), Истина, "ЧЦ=15; ЧДЦ=3", "РекомендуемыйОбъемЗакупки", "Рекомендуемый" + Символы.ПС + НСтр("ru='объем закупки';uk='обсяг купівлі'"));
	УниверсальныйОтчет.ДобавитьПоказатель("РекомендуемыйОбъемЗакупкиБазовыхЕдиниц", НСтр("ru='Базовых ед.';uk='Базових од.'"), Ложь, "ЧЦ=15; ЧДЦ=3", "РекомендуемыйОбъемЗакупки");
	УниверсальныйОтчет.ДобавитьПоказатель("РекомендуемыйОбъемЗакупкиЕдиницОтчетов", НСтр("ru='Ед. отчетов';uk='Од. звітів'"), Ложь, "ЧЦ=15; ЧДЦ=3", "РекомендуемыйОбъемЗакупки");
	
	УниверсальныйОтчет.ДобавитьПоказатель("СрокДоставки", НСтр("ru='Срок доставки';uk='Строк доставки'") + Символы.ПС + НСтр("ru='(в днях)';uk='(у днях)'"), Истина, "ЧЦ=15; ЧДЦ=0");
	...
	ЭлементОформления = УниверсальныйОтчет.ПостроительОтчета.УсловноеОформление.Добавить("ТребуетсяЗаказать", НСтр("ru='Требуется заказать';uk='Потрібно замовити'"));
	...
	ЭлементОформления.Оформление.Текст.Значение = НСтр("ru='Требуется заказать';uk='Потрібно замовити'");
	ЭлементОформления.Оформление.Текст.Использование = Истина;
	
	ЭлементОформления.Использование = Истина;
	
	ЭлементОформления = УниверсальныйОтчет.ПостроительОтчета.УсловноеОформление.Добавить("РекомендуетсяЗаказать", НСтр("ru='Рекомендуется заказать';uk='Рекомендується замовити'"));
	...
	ЭлементОформления.Оформление.ЦветТекста.Использование = Истина;
	ЭлементОформления.Оформление.Текст.Значение = НСтр("ru='Рекомендуется заказать';uk='Рекомендується замовити'");
	ЭлементОформления.Оформление.Текст.Использование = Истина;
	
	ЭлементОформления.Использование = Истина;
	
	ЭлементОформления = УниверсальныйОтчет.ПостроительОтчета.УсловноеОформление.Добавить("НеТребуетсяЗаказывать", НСтр("ru='Не требуется заказывать';uk='Не потрібно замовляти'"));
	...
	ЭлементОформления.Оформление.ЦветТекста.Использование = Истина;
	ЭлементОформления.Оформление.Текст.Значение = НСтр("ru='Не требуется заказывать';uk='Не потрібно замовляти'");
	ЭлементОформления.Оформление.Текст.Использование = Истина;
