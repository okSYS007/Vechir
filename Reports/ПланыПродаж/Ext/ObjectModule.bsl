...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("Планы.Контрагент", "Контрагент", НСтр("ru='Контрагент';uk='Контрагент'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_Контрагенты);
	...
	УниверсальныйОтчет.ДобавитьПоказатель(НСтр("ru='Количество';uk='Кількість'"), НСтр("ru='Ед. хранения';uk='Од. зберігання'"), истина, "ЧЦ=15; ЧДЦ=3", "Количество", НСтр("ru='Количество';uk='Кількість'"));
