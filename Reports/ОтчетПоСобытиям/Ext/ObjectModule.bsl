...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	мСтруктураСоответствияИмен = Новый Структура("Контрагент, КонтактноеЛицо, Событие", "Контрагент", НСтр("ru='Контактное лицо события';uk='Контактна особа події'"), НСтр("ru='Событие';uk='Подія'"));
	...
	Если ИспользоватьСвойстваИКатегории Тогда
		...
		НоваяСтрока.Представление = НСтр("ru='Контактное лицо';uk='Контактна особа'");
		НоваяСтрока.Назначение = ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_КонтактныеЛица;

		НоваяСтрока = ТаблицаПолей.Добавить();
		НоваяСтрока.ПутьКДанным = "События.КонтактноеЛицо";
		НоваяСтрока.Представление = НСтр("ru='Физическое лицо';uk='Фізична особа'"); 
		...
		НоваяСтрока.Представление = НСтр("ru='Событие';uk='Подія'");
