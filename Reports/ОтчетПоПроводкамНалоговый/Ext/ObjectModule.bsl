...
Функция ЗаголовокОтчета() Экспорт
	Возврат НСтр("ru='Отчет по проводкам (налоговый)';uk='Звіт по проводках (податковий)'");
...
Функция ПолучитьОписаниеНастроек()
	...
	Если ПоПодстрокеСодержание Тогда
		СтрокаОписания = СтрокаОписания + ?(ПустаяСтрока(СтрокаОписания),"","; ")+НСтр("ru='Содержание содержит ';uk='Зміст містить '")+Строка(Подстрока)+"'";
	КонецЕсли;
	Если ПоПодстрокеСубконто Тогда
		СтрокаОписания = СтрокаОписания + ?(ПустаяСтрока(СтрокаОписания),"","; ")+НСтр("ru='Субконто содержит ';uk='Субконто містить '")+Строка(Подстрока)+"'";
	КонецЕсли;
	...
	Если ПоНомеруЖурнала Тогда
		СтрокаОписания = СтрокаОписания + ?(ПустаяСтрока(СтрокаОписания),"","; ")+НСтр("ru='Номер журнала =';uk='Номер журналу ='")+Строка(НомерЖурнала);
	КонецЕсли;
	Если ПоРегистратору Тогда
		СтрокаОписания = СтрокаОписания + ?(ПустаяСтрока(СтрокаОписания),"","; ")+НСтр("ru='Регистратор =';uk='Реєстратор ='")+Строка(Регистратор);
	КонецЕсли;
