...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	Для Каждого ВидСубконто Из СписокВидовКорСубконто Цикл
		...
		ТекстКорСубконто = ТекстКорСубконто + ЛокализацияПовтИсп.ПолучитьПереводДляОтчетовНаСКД(Строка(ВидСубконто)) + ", ";	
	КонецЦикла;
	...
	Иначе
		ОбщийТекстСубконто = ОбщийТекстСубконто + НСтр("ru=' и ';uk=' і '") + ТекстКорСубконто;
	КонецЕсли;
