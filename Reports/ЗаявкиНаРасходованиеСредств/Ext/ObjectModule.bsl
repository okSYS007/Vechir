...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьПолеГруппировка("ФормаОплаты",           "ЗаявкаНаРасходование", "ФормаОплаты",         НСтр("ru='Наличные, безналичные';uk='Готівкові, безготівкові'"));
	УниверсальныйОтчет.ДобавитьПолеГруппировка("ВалютаДенежныхСредств", "ЗаявкаНаРасходование", "ВалютаДокумента",     НСтр("ru='Валюта денежных средств';uk='Валюта грошових коштів'"));
	УниверсальныйОтчет.ДобавитьПолеГруппировка("БанковскийСчетКасса",   "ЗаявкаНаРасходование", "БанковскийСчетКасса", НСтр("ru='Банковский счет, касса';uk='Банківський рахунок, каса'"));
