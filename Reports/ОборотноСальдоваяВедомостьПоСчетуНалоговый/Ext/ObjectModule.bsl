...
Функция ЗаголовокОтчета() Экспорт
	Если ЗначениеЗаполнено(Счет) Тогда
		Возврат  НСтр("ru='Оборотно-сальдовая ведомость по счету ';uk='Оборотно-сальдова відомість по рахунку '") + Счет + НСтр("ru=' (налоговый)';uk=' (податковий)'");		
	Иначе
		Возврат  НСтр("ru='Оборотно-сальдовая ведомость по счету <не выбран счет> (налоговый)';uk='Оборотно-сальдова відомість по рахунку <не обраний рахунок> (податковий)'");		
	КонецЕсли;	
...
Функция СформироватьЗапрос(СтруктураПараметров) Экспорт
	...
	ОграниченияПоПостроителюОтчета = БухгалтерскиеОтчеты.ПолучитьТекстОграниченийПоПостроителюОтчета(ПостроительОтчета, Запрос, ОтборПоВидамСубконто);
