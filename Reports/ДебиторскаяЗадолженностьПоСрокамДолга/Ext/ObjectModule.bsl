...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОстатокДолга", НСтр("ru='Остаток долга контрагента';uk='Залишок боргу контрагента'"));
	Для каждого СтрокаИнтервала из ТабИнтервалы Цикл
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ОстатокДолга", НСтр("ru='Остаток долга контрагента';uk='Залишок боргу контрагента'"), Истина, "ЧЦ=15; ЧДЦ=2", , );
	Для каждого СтрокаИнтервала из ТабИнтервалы Цикл
		Ном = СтрокаИнтервала.НомерИнтервала;
		УниверсальныйОтчет.ДобавитьПоказатель("ОстатокПериода" + Ном, СтрокаИнтервала.ИмяИнтервала, Истина, "ЧЦ=15; ЧДЦ=2", "ПоПериодам", НСтр("ru='В т.ч. по срокам возникновения долга:';uk='В т. ч. по строках виникнення боргу:'"));
	КонецЦикла;
...
Процедура СформироватьОтчет(ТабличныйДокумент) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(Интервал) Тогда
		Сообщить(НСтр("ru='Отчет может быть сформирован только при выбранном интервале.';uk='Звіт може бути сформований лише при вибраному інтервалі.'"), СтатусСообщения.Важное);
		Возврат;
	КонецЕсли;
