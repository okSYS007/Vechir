...
//
Процедура ЗаполнитьНачальныеНастройки(ИмяМакета = "СоставПоказателей") Экспорт

	МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет(ИмяМакета);
...
НоваяФорма.ОписаниеОтчета     = НСтр("ru = 'Утверждена приказом Министерства финансов Украины от 31.03.99 г. №87 (с последними изменениями согласно приказу Министерства финансов Украины от 09.12.2011 года N 1591)'; uk = 'Затверджена наказом Міністерства фінансів України від 31.03.99 р. №87 (з останніми змінами згідно наказу Міністерства фінансів України від 09.12.2011 року N 1591)'"); 
НоваяФорма.ДатаНачалоДействия = '2012-01-01';
НоваяФорма.ДатаКонецДействия  = '2012-12-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2013";
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к НП(С)БУ №1 ""Общие требования к финансовой отчетности"" с изменениями внесенными Приказом Минфина Украины от 07.02.2013 №73'; uk = 'Додаток до НП(С)БО  №1 ""Загальні вимоги до фінансової звітності""  зі змінами внесеними Наказом Мінфина України від 07.02.2013 № 73'");
