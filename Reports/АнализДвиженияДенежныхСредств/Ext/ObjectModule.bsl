...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументДвижения", НСтр("ru='Документ движения';uk='Документ руху'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументПланированияПлатежа", НСтр("ru='Документ планирования платежа';uk='Документ планування платежу'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВалютаДенежныхСредств", НСтр("ru='Валюта движения';uk='Валюта руху'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПриходРасход", НСтр("ru='Вид движения';uk='Вид руху'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаПриходВал", НСтр("ru='Поступления в валюте операций';uk='Надходження у валюті операцій'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаРасходВал", НСтр("ru='Платежи в валюте операций';uk='Платежі у валюті операцій'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДенежныйПотокВал", НСтр("ru='Чистый денежный поток в валюте операций';uk='Чистий грошовий потік у валюті операцій'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаПриходУпр", НСтр("ru='Поступления в валюте упр. учета (';uk='Надходження у валюті упр. обліку ('") + глЗначениеПеременной("ВалютаУправленческогоУчета") + ")");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаРасходУпр", НСтр("ru='Платежи в валюте упр. учета (';uk='Платежі у валюті упр. обліку ('") + глЗначениеПеременной("ВалютаУправленческогоУчета") + ")");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДенежныйПотокУпр", НСтр("ru='Чистый денежный поток в валюте упр. учета (';uk='Чистий грошовий потік у валюті упр. обліку ('") + глЗначениеПеременной("ВалютаУправленческогоУчета") + ")");

	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаПриходВал", НСтр("ru='Поступления';uk='Надходження'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2", "ВВалютеОпераций", НСтр("ru='В валюте операций';uk='У валюті операцій'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаРасходВал", НСтр("ru='Платежи';uk='Платежі'"), Ложь, "ЧЦ = 15 ; ЧДЦ = 2", "ВВалютеОпераций");
	УниверсальныйОтчет.ДобавитьПоказатель("ДенежныйПотокВал", НСтр("ru='Чистый денежный поток';uk='Чистий грошовий потік'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2", "ВВалютеОпераций");
	
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаПриходУпр", НСтр("ru='Поступления';uk='Надходження'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2", "ВВалютеУпрУчета", НСтр("ru='В валюте упр учета (';uk='У валюті упр обліку ('") + глЗначениеПеременной("ВалютаУправленческогоУчета") + ")");
