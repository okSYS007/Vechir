...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ОбщийОтчет.ИмяРегистра = "ПартииМалоценкиВЭксплуатации";
	ОбщийОтчет.мВыбиратьИмяРегистра = Ложь;
	ОбщийОтчет.НП = Новый НастройкаПериода;
	ОбщийОтчет.мСтруктураДляОтбораПоКатегориям = Новый Структура;

	ОбщийОтчет.мНазваниеОтчета = НСтр("ru='Ведомость по партиям малоценки в эксплуатации';uk='Відомість по партіях малоцінки в експлуатації'");
	
	СтруктураПредставлениеПолей = Новый Структура;
	МассивОтбора = Новый Массив;
	
	УправлениеОтчетами.ЗаполнитьНачальныеНастройкиПоМакету(ПолучитьМакет("ПараметрыОтчетовПартииМалоценкиВЭксплуатации"), СтруктураПредставлениеПолей, МассивОтбора, ОбщийОтчет, "ОстаткиИОбороты");
