...
НоваяФорма.ОписаниеОтчета     = "Додаток до Положення ( стандарту) бухгалтерського обліку 3 (зі змінами, внесеними наказом МФУ № 1204 від 26.09.2011 р.)";
НоваяФорма.ДатаНачалоДействия = '20111001';
НоваяФорма.ДатаКонецДействия  = '2011-12-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2013Кв1";
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к П(с)БУ №1 ""Общие требования к финансовой отчетности"" с изменениями внесенными Приказом Минфина Украины от 07.02.2013 №73'; uk = 'Додаток до П(с)БО  №1 ""Загальні вимоги до фінансової звітності""  зі змінами внесеними Наказом Мінфина України від 07.02.2013 № 73'");
НоваяФорма.ДатаНачалоДействия = '2013-01-01';
НоваяФорма.ДатаКонецДействия  = '2014-03-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2012Кв1";
НоваяФорма.ОписаниеОтчета     = "Додаток до Положення ( стандарту) бухгалтерського обліку 3 (зі змінами, внесеними наказом МФУ № 1591 від 09.12.2011 р.)";
НоваяФорма.ДатаНачалоДействия = '2012-01-01';
НоваяФорма.ДатаКонецДействия  = '2012-12-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2014Кв2";
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к НП(С)БУ №1 ""Общие требования к финансовой отчетности"" с изменениями внесенными Приказом Минфина Украины от 08.02.2014 № 48'; uk = 'Додаток до НП(С)БО  №1 ""Загальні вимоги до фінансової звітності""  зі змінами внесеними Наказом Мінфина України від 08.02.2014 № 48'");
