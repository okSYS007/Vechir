...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ЗаказыПоставщикамОстаткиИОбороты.ДоговорКонтрагента",          "ДоговорКонтрагента",         НСтр("ru='Договор контрагента';uk='Договір контрагента'"),         ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ДоговорыКонтрагентов);
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ЗаказыПоставщикамОстаткиИОбороты.ХарактеристикаНоменклатуры",  "ХарактеристикаНоменклатуры", НСтр("ru='Характеристика номенклатуры';uk='Характеристика номенклатури'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ХарактеристикиНоменклатуры);
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ЗаказыПоставщикамОстаткиИОбороты.ЗаказПоставщику",             "ЗаказПоставщику",            НСтр("ru='Заказ поставщику';uk='Замовлення постачальнику'"),            ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Документы);
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗаказПоставщику", НСтр("ru='Заказ';uk='Замовлення'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СостояниеОтгрузки", НСтр("ru='Состояние поступления';uk='Стан надходження'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СостояниеОплаты", НСтр("ru='Состояние оплаты';uk='Стан оплати'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаЗаказа", НСтр("ru='Сумма заказа';uk='Сума замовлення'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаЗапланировано", НСтр("ru='Сумма запланировано оплатить';uk='Сума заплановано сплатити'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Оплачено", НСтр("ru='Оплачено';uk='Оплачено'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьЗакупитьСуммаВзаиморасчетов", НСтр("ru='Осталось закупить (сумма в валюте взаиморасчетов)';uk='Залишилось закупити (сума у валюті взаєморозрахунків)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьЗакупитьСуммаУпр", НСтр("ru='Осталось закупить (сумма в валюте упр. учета)';uk='Залишилось закупити (сума у валюті упр. обліку)'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОтгрузить",  НСтр("ru='Осталось закупить';uk='Залишилось закупити'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Заказано",           НСтр("ru='Размещено в заказе';uk='Розміщено в замовленні'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОтгрузитьБазовыхЕд",  НСтр("ru='Осталось закупить (в базовых ед.)';uk='Залишилось закупити (у базових од.)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗаказаноБазовыхЕд",           НСтр("ru='Размещено в заказе (в базовых ед.)';uk='Розміщено в замовленні (у базових од.)'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОсталосьОтгрузитьЕдиницОтчетов",  НСтр("ru='Осталось закупить (в ед. отчетов)';uk='Залишилось закупити (в од. звітів)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗаказаноЕдиницОтчетов",           НСтр("ru='Размещено в заказе (в ед. отчетов)';uk='Розміщено в замовленні (в од. звітів)'"));
	
	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаЗаказа",        НСтр("ru='Сумма заказа';uk='Сума замовлення'"),   				Истина, "ЧЦ=15; ЧДЦ=2", "Оплата", "Оплата");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаЗапланировано", НСтр("ru='Сумма запланировано оплатить';uk='Сума заплановано сплатити'"),	Истина, "ЧЦ=15; ЧДЦ=2", "Оплата", "Оплата");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("Оплачено",   		НСтр("ru='Оплачено';uk='Оплачено'"),			 			Истина, "ЧЦ=15; ЧДЦ=2", "Оплата", "Оплата");
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьЗакупитьСуммаУпр",			 НСтр("ru='Осталось закупить ';uk='Залишилось закупити '")+Символы.ПС+ НСтр("ru='(в валюте упр. учета)';uk='(у валюті упр. обліку)'"),	   Ложь, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьЗакупитьСуммаВзаиморасчетов", НСтр("ru='Осталось закупить ';uk='Залишилось закупити '")+Символы.ПС+ НСтр("ru='(в валюте взаиморасчетов)';uk='(у валюті взаєморозрахунків)'"),Ложь, "ЧЦ=15; ЧДЦ=2");
	
	УниверсальныйОтчет.ДобавитьПоказатель("Запланировано",      НСтр("ru='Запланировано';uk='Заплановано'"),      Истина, "ЧЦ=15; ЧДЦ=3", "Отгрузка", НСтр("ru='Закупка (в ед. хранения)';uk='Купівля (в од. зберігання)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОтгрузить",  НСтр("ru='Осталось закупить';uk='Залишилось закупити'"),  Истина, "ЧЦ=15; ЧДЦ=3", "Отгрузка", НСтр("ru='Закупка (в ед. хранения)';uk='Купівля (в од. зберігання)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("Заказано",           НСтр("ru='Размещено в заказе';uk='Розміщено в замовленні'"), Истина, "ЧЦ=15; ЧДЦ=3", "Отгрузка", НСтр("ru='Закупка (в ед. хранения)';uk='Купівля (в од. зберігання)'"));
	
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоБазовыхЕд",      НСтр("ru='Запланировано';uk='Заплановано'"),      Ложь, "ЧЦ=15; ЧДЦ=3", "ОтгрузкаБазовыхЕд", НСтр("ru='Закупка (в базовых ед.)';uk='Купівля (в базових од.)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОтгрузитьБазовыхЕд",  НСтр("ru='Осталось закупить';uk='Залишилось закупити'"),  Ложь, "ЧЦ=15; ЧДЦ=3", "ОтгрузкаБазовыхЕд", НСтр("ru='Закупка (в базовых ед.)';uk='Купівля (в базових од.)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноБазовыхЕд",           НСтр("ru='Размещено в заказе';uk='Розміщено в замовленні'"), Ложь, "ЧЦ=15; ЧДЦ=3", "ОтгрузкаБазовыхЕд", НСтр("ru='Закупка (в базовых ед.)';uk='Купівля (в базових од.)'"));
	
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоЕдиницОтчетов",      НСтр("ru='Запланировано';uk='Заплановано'"),       Ложь, "ЧЦ=15; ЧДЦ=3", "ОтгрузкаЕдиницОтчетов", НСтр("ru='Закупка (в ед. отчетов)';uk='Купівля (в од. звітів)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ОсталосьОтгрузитьЕдиницОтчетов",  НСтр("ru='Осталось закупить';uk='Залишилось закупити'"),   Ложь, "ЧЦ=15; ЧДЦ=3", "ОтгрузкаЕдиницОтчетов", НСтр("ru='Закупка (в ед. отчетов)';uk='Купівля (в од. звітів)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноЕдиницОтчетов",           НСтр("ru='Размещено в заказе';uk='Розміщено в замовленні'"),  Ложь, "ЧЦ=15; ЧДЦ=3", "ОтгрузкаЕдиницОтчетов", НСтр("ru='Закупка (в ед. отчетов)';uk='Купівля (в од. звітів)'"));
