...
Процедура СформироватьОтчет(ТабличныйДокумент) Экспорт
	...
	Если Не ЗначениеЗаполнено(Склад) Тогда
		Сообщить(НСтр("ru='Отчет может быть сформирован только при выбранном складе.';uk='Звіт може бути сформований тільки при вибраному складі.'"), СтатусСообщения.Важное);
		Возврат;
	ИначеЕсли Склад.ВидСклада <> Перечисления.ВидыСкладов.Розничный Тогда
		Сообщить(НСтр("ru='Отчет может быть сформирован только для розничного склада.';uk='Звіт може бути сформований лише для роздрібного складу.'"), СтатусСообщения.Важное);
		Возврат;
	КонецЕсли;
