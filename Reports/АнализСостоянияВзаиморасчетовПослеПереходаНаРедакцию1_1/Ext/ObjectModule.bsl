...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
        ...
        УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("ЗапросПоРегистрам.ДоговорКонтрагента" , "ДоговорКонтрагента", НСтр("ru='Договор контрагента';uk='Договір контрагента'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ДоговорыКонтрагентов);
        УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("ЗапросПоРегистрам.ДокументРасчетовСКонтрагентом" , "ДокументРасчетовСКонтрагентом", НСтр("ru='Документ расчетов с контрагентом';uk='Документ розрахунків з контрагентом'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Документы);
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоСделкеНачальныйОстаток", НСтр("ru='По сделке начальный остаток';uk='По угоді початковий залишок'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоСделкеКонечныйОстаток",  НСтр("ru='По сделке конечный остаток';uk='По угоді кінцевий залишок'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоСделкеПриход",           НСтр("ru='По сделке приход';uk='По угоді прибуток'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоСделкеРасход",           НСтр("ru='По сделке расход';uk='По угоді витрата'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоДокументуНачальныйОстаток",            НСтр("ru='По док.расч. начальный остаток';uk='По док.розр. початковий залишок'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоДокументуКонечныйОстаток",             НСтр("ru='По док. расч. конечный остаток';uk='По док. розр. кінцевий залишок'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоДокументуПриход",                      НСтр("ru='По док. расч. приход';uk='За док. розрах. прибуток'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВзаиморасчетовПоДокументуРасход",                      НСтр("ru='По док. расч. расход';uk='По док. розр. витрата'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РасхождениеНачальныйОстаток", НСтр("ru='Расхождение начальный остаток';uk='Розбіжність початковий залишок'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РасхождениеКонечныйОстаток",  НСтр("ru='Расхождение конечный остаток';uk='Розбіжність кінцевий залишок'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РасхождениеПриход",           НСтр("ru='Расхождениее приход';uk='Розходження прибуток'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РасхождениеРасход",           НСтр("ru='Расхождение расход';uk='Розбіжність витрата'"));
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоСделкеНачальныйОстаток", НСтр("ru='нач. остаток';uk='поч. залишок'"), Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоСделке", НСтр("ru='Сумма взаиморасчетов по сделке';uk='Сума взаєморозрахунків за угодою'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоСделкеПриход",           НСтр("ru='приход';uk='прибуток'"),       Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоСделке", НСтр("ru='Сумма взаиморасчетов по сделке';uk='Сума взаєморозрахунків за угодою'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоСделкеРасход",           НСтр("ru='расход';uk='витрата'"),       Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоСделке", НСтр("ru='Сумма взаиморасчетов по сделке';uk='Сума взаєморозрахунків за угодою'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоСделкеКонечныйОстаток",  НСтр("ru='кон. остаток';uk='кін. залишок'"), Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоСделке", НСтр("ru='Сумма взаиморасчетов по сделке';uk='Сума взаєморозрахунків за угодою'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоДокументуНачальныйОстаток",            НСтр("ru='нач. остаток';uk='поч. залишок'"), Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоДокументу", НСтр("ru='Сумма взаиморасчетов по документам расчетов';uk='Сума взаєморозрахунків за документами розрахунків'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоДокументуПриход",                      НСтр("ru='приход';uk='прибуток'"),       Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоДокументу", НСтр("ru='Сумма взаиморасчетов по документам расчетов';uk='Сума взаєморозрахунків за документами розрахунків'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоДокументуРасход",                      НСтр("ru='расход';uk='витрата'"),       Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоДокументу", НСтр("ru='Сумма взаиморасчетов по документам расчетов';uk='Сума взаєморозрахунків за документами розрахунків'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПоДокументуКонечныйОстаток",             НСтр("ru='кон. остаток';uk='кін. залишок'"), Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетовПоДокументу", НСтр("ru='Сумма взаиморасчетов по документам расчетов';uk='Сума взаєморозрахунків за документами розрахунків'"));
	УниверсальныйОтчет.ДобавитьПоказатель("РасхождениеНачальныйОстаток",            НСтр("ru='нач. остаток';uk='поч. залишок'"), Истина, "ЧЦ=15; ЧДЦ=2", "Расхождение", НСтр("ru='Расхождение';uk='Розбіжність'"));
	УниверсальныйОтчет.ДобавитьПоказатель("РасхождениеПриход",                      НСтр("ru='приход';uk='прибуток'"),       Истина, "ЧЦ=15; ЧДЦ=2", "Расхождение", НСтр("ru='Расхождение';uk='Розбіжність'"));
	УниверсальныйОтчет.ДобавитьПоказатель("РасхождениеРасход",                      НСтр("ru='расход';uk='витрата'"),       Истина, "ЧЦ=15; ЧДЦ=2", "Расхождение", НСтр("ru='Расхождение';uk='Розбіжність'"));
	УниверсальныйОтчет.ДобавитьПоказатель("РасхождениеКонечныйОстаток",             НСтр("ru='кон. остаток';uk='кін. залишок'"), Истина, "ЧЦ=15; ЧДЦ=2", "Расхождение", НСтр("ru='Расхождение';uk='Розбіжність'"));
	...
	Для каждого ВидДокумента Из СписокДокументов цикл
		...
		Пока ЕстьДокументы Цикл
			...
			Для Каждого Строка Из ТаблицаДокументов Цикл
				...
				КонецЕсли;
				Заголовок = НСтр("ru='Обновляются реквизиты документа: ';uk='Оновлюються реквізити документа: '") + СокрЛП(ДокументСсылка) + ВидОперацииСтр;
				Состояние(Заголовок);
...
Процедура ПлатежныеДокументы_ОчиститьРеквизитСделка()
    ...
    СписокДокументов.Добавить("ПлатежноеТребованиеПоручениеВыставленное");
    СписокДокументов.Добавить("ПлатежноеТребованиеПоручениеПолученное");
		...
		Пока ЕстьДокументы Цикл
			...
			Для Каждого Строка Из ТаблицаДокументов Цикл
				...
				Если МетаданныеДокумента.Реквизиты.Найти("ВидОперации") <> Неопределено Тогда
					ВидОперацииСтр = " (" + ДокументСсылка.ВидОперации + ")";
				КонецЕсли;
				Заголовок = НСтр("ru='Обновляются движения документа: ';uk='Оновляються рухи документа: '") + СокрЛП(ДокументСсылка) + ВидОперацииСтр;
				Состояние(Заголовок);
