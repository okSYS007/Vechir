...
Функция ПроверитьЗаполнениеКалендаря(МассивВидовДоговоров)
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Если ЗначениеЗаполнено(СтрокаДанныхКалендаря.ДатаДокументаМинимум) И НЕ ЗначениеЗаполнено(СтрокаДанныхКалендаря.ДатаКалендаряМинимум) Тогда
			строкаПредупреждения = НСтр("ru='Не заполнен Регламентированный производственный календарь на дату ';uk='Не заповнений Регламентований виробничий календар на дату '") + СтрокаДанныхКалендаря.ДатаДокументаМинимум + Символы.ПС;
			ЕстьОшибки = Истина;
		КонецЕсли;
		Если ЗначениеЗаполнено(СтрокаДанныхКалендаря.ДатаДокументаМаксимум) И НЕ ЗначениеЗаполнено(СтрокаДанныхКалендаря.ДатаКалендаряМаксимум) Тогда
			строкаПредупреждения = НСтр("ru='Не заполнен Регламентированный производственный календарь на дату ';uk='Не заповнений Регламентований виробничий календар на дату '") + СтрокаДанныхКалендаря.ДатаДокументаМаксимум;
			ЕстьОшибки = Истина;
		КонецЕсли;
	КонецЕсли;
...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ВзаиморасчетыОстаткиИОбороты.ДоговорКонтрагента" ,   "ДоговорКонтрагента",   НСтр("ru='Договор контрагента';uk='Договір контрагента'"),   ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ДоговорыКонтрагентов);
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ВзаиморасчетыОстаткиИОбороты.Организация" ,   "Организация",   НСтр("ru='Организация';uk='Організація'"),   ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_Организации);
	...
	// Необходимо вызывать для каждого поля запроса.
	 ...
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументРасчетовСКонтрагентом",    НСтр("ru='Документ отгрузки';uk='Документ відвантаження'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Отгрузка", НСтр("ru='Сумма отгрузки';uk='Сума відвантаження'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОтгрузкаУпр", НСтр("ru='Сумма отгрузки (упр.)';uk='Сума відвантаження (упр.)'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Оплата", НСтр("ru='Сумма оплаты';uk='Сума оплати'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОплатаУпр", НСтр("ru='Сумма оплаты (упр.)';uk='Сума оплати (упр.)'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЧислоДней", НСтр("ru='Длительность кредитной линии';uk='Тривалість кредитної лінії'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДолгКонтрагента", НСтр("ru='Долг контрагента';uk='Борг контрагента'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДолгКонтрагентаУпр", НСтр("ru='Долг контрагента (упр.)';uk='Борг контрагента (упр.)'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Регистратор", НСтр("ru='Документ оплаты';uk='Документ оплати'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ГлубинаКредитнойЛинии", НСтр("ru='Глубина кредитной линии';uk='Глибина кредитної лінії'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДатаОтгрузки", НСтр("ru='Дата отгрузки';uk='Дата відвантаження'"));
	 УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Срок", НСтр("ru='Срок оплаты';uk='Строк оплати'"));

	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	УниверсальныйОтчет.ДобавитьПоказатель("Отгрузка", НСтр("ru='Сумма отгрузки';uk='Сума відвантаження'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ОтгрузкаУпр", НСтр("ru='Сумма отгрузки (упр.)';uk='Сума відвантаження (упр.)'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("Оплата", НСтр("ru='Сумма оплаты';uk='Сума оплати'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ОплатаУпр", НСтр("ru='Сумма оплаты (упр.)';uk='Сума оплати (упр.)'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ДолгКонтрагента", НСтр("ru='Долг контрагента';uk='Борг контрагента'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ДолгКонтрагентаУпр", НСтр("ru='Долг контрагента (упр.)';uk='Борг контрагента (упр.)'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ДатаОтгрузки", НСтр("ru='Дата отгрузки';uk='Дата відвантаження'"), Истина, "ДФ=dd.MM.yyyy");
	УниверсальныйОтчет.ДобавитьПоказатель("Срок", НСтр("ru='Срок оплаты';uk='Строк оплати'"), Истина, "ДФ=dd.MM.yyyy");
