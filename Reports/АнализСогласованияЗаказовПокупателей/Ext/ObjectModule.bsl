...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СостояниеСогласования", НСтр("ru='Состояние';uk='Стан'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("НомерЦикла",            НСтр("ru='Цикл согласования';uk='Цикл узгодження'"));
