...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("БанковскийСчетКасса", НСтр("ru='Банковский счет/касса';uk='Банківський рахунок/каса'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВидДенежныхСредств", НСтр("ru='Вид денежных средств';uk='Вид грошових коштів'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВалютаСчетаКассы", НСтр("ru='Валюта счета/кассы';uk='Валюта рахунку/каси'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ТекущийОстатокВВалютеДенСредств", НСтр("ru='Остаток в валюте банковского счета/кассы';uk='Залишок у валюті банківського рахунку/каси'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ТекущийОстатокВУпрВалюте", НСтр("ru='Остаток в валюте упр. учета';uk='Залишок у валюті упр. обліку'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаКСписаниюВВалютеДенСредств", НСтр("ru='К списанию в валюте банковского счета/кассы';uk='До списання у валюті банківського рахунку/каси'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаКСписаниюВУпрВалюте", НСтр("ru='К списанию в валюте упр. учета';uk='До списання у валюті упр. обліку'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаКПолучениюВВалютеДенСредств", НСтр("ru='К получению в валюте банковского счета/кассы';uk='До отримання у валюті банківського рахунку/каси'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаКПолучениюВУпрВалюте", НСтр("ru='К получению в валюте упр. учета';uk='До отримання у валюті упр. обліку'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВРезервеВВалютеДенСредств", НСтр("ru='В резерве в валюте банковского счета/кассы';uk='В резерві у валюті банківського рахунку/каси'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаВРезервеВУпрВалюте", НСтр("ru='В резерве в валюте упр. учета';uk='В резерві у валюті упр. обліку'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаСвободныйОстатокВВалютеДенСредств", НСтр("ru='Свободный остаток в валюте банковского счета/кассы';uk='Вільний залишок в валюті банківського рахунку/каси'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаСвободныйОстатокВУпрВалюте", НСтр("ru='Свободный остаток в валюте упр. учета';uk='Вільний залишок в валюті упр. обліку'"));

	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	УниверсальныйОтчет.ДобавитьПоказатель("ТекущийОстатокВВалютеДенСредств", НСтр("ru='Остаток в валюте банковского счета/кассы';uk='Залишок у валюті банківського рахунку/каси'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("ТекущийОстатокВУпрВалюте", НСтр("ru='Остаток в валюте упр. учета';uk='Залишок у валюті упр. обліку'"), Ложь, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаКСписаниюВВалютеДенСредств", НСтр("ru='К списанию в валюте банковского счета/кассы';uk='До списання у валюті банківського рахунку/каси'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаКСписаниюВУпрВалюте", НСтр("ru='К списанию в валюте упр. учета';uk='До списання у валюті упр. обліку'"), Ложь, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаКПолучениюВВалютеДенСредств", НСтр("ru='К получению в валюте банковского счета/кассы';uk='До отримання у валюті банківського рахунку/каси'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаКПолучениюВУпрВалюте", НСтр("ru='К получению в валюте упр. учета';uk='До отримання у валюті упр. обліку'"), Ложь, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВРезервеВВалютеДенСредств", НСтр("ru='В резерве в валюте банковского счета/кассы';uk='В резерві у валюті банківського рахунку/каси'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВРезервеВУпрВалюте", НСтр("ru='В резерве в валюте упр. учета';uk='В резерві у валюті упр. обліку'"), Ложь, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаСвободныйОстатокВВалютеДенСредств", НСтр("ru='Свободный остаток в валюте банковского счета/кассы';uk='Вільний залишок в валюті банківського рахунку/каси'"), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаСвободныйОстатокВУпрВалюте", НСтр("ru='Свободный остаток в валюте упр. учета';uk='Вільний залишок в валюті упр. обліку'"), Ложь, "ЧЦ = 15 ; ЧДЦ = 2");
