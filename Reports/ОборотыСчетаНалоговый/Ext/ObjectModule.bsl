...
Функция ЗаголовокОтчета() Экспорт
	...
	ИмяОтчета = НСтр("ru='Обороты счета ';uk='Обороти рахунку '");
	
	Возврат ИмяОтчета + ?(ЗначениеЗаполнено(Счет), Счет, НСтр("ru='(не выбран счет)';uk='(не обраний рахунок)'"));
...
Процедура ВывестиКорСчета(ВыборкаОборотыПоКорСчетам, СтруктураПараметров, ВидОборота, Ресурсы, ВыводимаяОбласть, 
	...
	// Создадим структуру соответствиия кор счетов структуре ресурство
