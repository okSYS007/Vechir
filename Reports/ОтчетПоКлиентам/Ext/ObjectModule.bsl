...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("ЗапросПоВзаиморасчетам.Организация", "Организация", НСтр("ru='Организация';uk='Організація'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_Организации);
        ...
        УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("ЗапросПоВзаиморасчетам.ХарактеристикаНоменклатуры", "ХарактеристикаНоменклатуры", НСтр("ru='Характеристика номенклатуры';uk='Характеристика номенклатури'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ХарактеристикиНоменклатуры);
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("ЗапросПоВзаиморасчетам.ДоговорКонтрагента", "ДоговорКонтрагента", НСтр("ru='Договор контрагента';uk='Договір контрагента'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ДоговорыКонтрагентов);
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументСделка", НСтр("ru='Сделка';uk='Угода'"));
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументДвижения", НСтр("ru='Документ движения средств';uk='Документ руху коштів'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаНачальныйДолг", НСтр("ru='Долг на начало';uk='Борг на початок'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаОплаченоДеб", НСтр("ru='Всего (приход от контрагента)';uk='Всього (надходження від контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаОплаченоКред", НСтр("ru='Всего (расход на контрагента)';uk='Всього (витрата на контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаПриход", НСтр("ru='Сумма в (';uk='Сума у ('") + ВалютаУпр + НСтр("ru=') (приход от контрагента)';uk=') (надходження від контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаРасход", НСтр("ru='Сумма в (';uk='Сума у ('") + ВалютаУпр + НСтр("ru=') (расход на контрагента)';uk=') (витрати на контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоПриход", НСтр("ru='Количество (в ед. хранения) (приход от контрагента)';uk='Кількість (в од. зберігання) (надходження від контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоРасход", НСтр("ru='Количество (в ед. хранения) (расход на контрагента)';uk='Кількість (в од. зберігання) (витрати на контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоЕдиницДляОтчетовПриход", НСтр("ru='Количество (в ед. отчетов) (приход от контрагента)';uk='Кількість (в од. звітів) (надходження від контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоЕдиницДляОтчетовРасход", НСтр("ru='Количество (в ед. отчетов) (расход на контрагента)';uk='Кількість (в од. звітів) (витрати на контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаКонечныйДолг", НСтр("ru='Долг на конец';uk='Борг на кінець'"));
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЦенаПриход", НСтр("ru='Цена (приход от контрагента)';uk='Ціна (надходження від контрагента)'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЦенаРасход", НСтр("ru='Цена (расход на контрагента)';uk='Ціна (витрати на контрагента)'"));
	
	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаНачальныйДолг", НСтр("ru='Долг на начало';uk='Борг на початок'"), Истина, "ЧЦ=15; ЧДЦ=2");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаОплаченоДеб", НСтр("ru='Всего';uk='Всього'"), Истина, "ЧЦ=15; ЧДЦ=2", "Приход", НСтр("ru='Поступление ТМЦ (работ, услуг)';uk='Надходження ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаПриход", НСтр("ru='Сумма в (';uk='Сума у ('") + ВалютаУпр + ")", Истина, "ЧЦ=15; ЧДЦ=2", "Приход", НСтр("ru='Приход от контрагента';uk='Надходження від контрагента'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаРасход", НСтр("ru='Сумма в (';uk='Сума у ('") + ВалютаУпр + ")", Истина, "ЧЦ=15; ЧДЦ=2", "Расход", НСтр("ru='Расход на контрагента';uk='Витрата на контрагента'"));
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоПриход", НСтр("ru='Количество (в ед. хранения)';uk='Кількість (в од. зберігання)'"), Истина, "ЧЦ=15; ЧДЦ=3", "Приход", НСтр("ru='Поступление ТМЦ (работ, услуг)';uk='Надходження ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоЕдиницДляОтчетовПриход", НСтр("ru='Количество (в ед. отчетов)';uk='Кількість (в од. звітів)'"), Ложь, "ЧЦ=15; ЧДЦ=3", "Приход", НСтр("ru='Поступление ТМЦ (работ, услуг)';uk='Надходження ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЦенаПриход", НСтр("ru='Цена';uk='Ціна'"), Истина, "ЧЦ=15; ЧДЦ=2", "Приход", НСтр("ru='Поступление ТМЦ (работ, услуг)';uk='Надходження ТМЦ (робіт, послуг)'"));
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаОплаченоКред", НСтр("ru='Всего';uk='Всього'"), Истина, "ЧЦ=15; ЧДЦ=2", "Расход", НСтр("ru='Реализация ТМЦ (работ, услуг)';uk='Реалізація ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаРасход", НСтр("ru='Сумма в (';uk='Сума у ('") + ВалютаУпр + ")", Истина, "ЧЦ=15; ЧДЦ=2", "Расход", НСтр("ru='Реализация ТМЦ (работ, услуг)';uk='Реалізація ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоРасход", НСтр("ru='Количество (в ед. хранения)';uk='Кількість (в од. зберігання)'"), Истина, "ЧЦ=15; ЧДЦ=3", "Расход", НСтр("ru='Реализация ТМЦ (работ, услуг)';uk='Реалізація ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоЕдиницДляОтчетовРасход", НСтр("ru='Количество (в ед. отчетов)';uk='Кількість (в од. звітів)'"), Ложь, "ЧЦ=15; ЧДЦ=3", "Расход", НСтр("ru='Реализация ТМЦ (работ, услуг)';uk='Реалізація ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("ЦенаРасход", НСтр("ru='Цена';uk='Ціна'"), Истина, "ЧЦ=15; ЧДЦ=2", "Расход", НСтр("ru='Реализация ТМЦ (работ, услуг)';uk='Реалізація ТМЦ (робіт, послуг)'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаКонечныйДолг",  НСтр("ru='Долг на конец';uk='Борг на кінець'"),        Истина, "ЧЦ=15; ЧДЦ=2");
