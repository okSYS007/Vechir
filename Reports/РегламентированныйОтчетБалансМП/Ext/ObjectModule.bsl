...
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к Положению (стандарту) бухучета №25 (с изменениями, внесенными приказами Минфином Украины №1591 от 09.12.11)'; uk = 'Додаток до Положення (стандарту) бухобліку №25 (зі змінами, внесеними наказами Мінфіном України №1125 від 25.09.09, №1591 від 09.12.11 '");
НоваяФорма.ДатаНачалоДействия = '20120101';
НоваяФорма.ДатаКонецДействия  = '20130630';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2013Кв3";
НоваяФорма.ОписаниеОтчета     =  НСтр("ru='Приложение к НП(С)БУ №25 (с изменениями, внесенными приказами Минфина Украины №48 от 08.02.14, №226 от 31.05.19)';uk='Додаток до НП(С)БО №25 (зі змінами, внесеними наказами Мінфіну України №48 от 08.02.14, №226 от 31.05.19)'");
...
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к Положению (стандарту) бухучета №25 (с изменениями, внесенными приказами Минфина Украины № 48 от 08.02.14 г.)'; uk = 'Додаток до Положення (стандарту) бухобліку №25 (зі змінами, внесеними наказами Мінфіном України № 48 від 08.02.14 р.)'");
НоваяФорма.ДатаНачалоДействия = '20140101';
НоваяФорма.ДатаКонецДействия  = "20190731";
	
НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2019Кв3";
НоваяФорма.ОписаниеОтчета     =  НСтр("ru='Приложение к НП(С)БУ №25 (с изменениями, внесенными приказами Минфина Украины № 48 от 08.02.14 г. и № 226 от 31.05.19 г.)';uk='Додаток до НП(С)БО №25 (зі змінами, внесеними наказами Мінфіну України № 48 від 08.02.14 р. та № 226 від 31.05.19 р.)'");
