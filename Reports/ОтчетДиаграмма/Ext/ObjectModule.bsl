...
Процедура ПолучитьДиаграммуНаПечать(ДокументРезультат) Экспорт
	...
	Диаграмма.ОбластьЗаголовка.Текст = ЛокализацияПовтИсп.ПолучитьПереводТекста(мНазваниеОтчета) + ": " + ЛокализацияПовтИсп.ПолучитьПереводТекста(ВыводимыйПоказатель);
	...
	ДокументРезультат.Рисунки.Диаграмма.Объект.ОбластьЗаголовка.Текст = ЛокализацияПовтИсп.ПолучитьПереводТекста(мНазваниеОтчета) + ": " + ЛокализацияПовтИсп.ПолучитьПереводТекста(ВыводимыйПоказатель);
