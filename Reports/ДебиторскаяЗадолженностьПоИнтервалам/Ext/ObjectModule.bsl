...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("РегВзаиморасчеты.ДоговорКонтрагента", "ДоговорКонтрагента", НСтр("ru='Договор контрагента';uk='Договір контрагента'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ДоговорыКонтрагентов);
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("РегВзаиморасчеты.Организация", "Организация", НСтр("ru='Организация';uk='Організація'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_Организации);
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовНачальныйОстаток", НСтр("ru='нач. остаток';uk='поч. залишок'"), Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетов", НСтр("ru='Сумма взаиморасчетов';uk='Сума взаєморозрахунків'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовПриход", НСтр("ru='приход';uk='прибуток'"), Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетов", НСтр("ru='Сумма взаиморасчетов';uk='Сума взаєморозрахунків'"));
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВзаиморасчетовРасход", НСтр("ru='расход';uk='витрата'"), Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаВзаиморасчетов", НСтр("ru='Сумма взаиморасчетов';uk='Сума взаєморозрахунків'"));
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаУпрНачальныйОстаток", НСтр("ru='нач. остаток';uk='поч. залишок'"), Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаУпр", НСтр("ru='Сумма ';uk='Сума '") + ВалютаУпр);
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаУпрПриход", НСтр("ru='приход';uk='прибуток'"), Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаУпр", НСтр("ru='Сумма ';uk='Сума '") + ВалютаУпр);
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаУпрРасход", НСтр("ru='расход';uk='витрата'"), Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаУпр", НСтр("ru='Сумма ';uk='Сума '") + ВалютаУпр);
