...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "ДокументРезерва",            НСтр("ru='Документ резерва';uk='Документ резерву'"));
	...
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоОстаток", НСтр("ru='Количество';uk='Кількість'"), Истина, "ЧЦ=15; ЧДЦ=3");
