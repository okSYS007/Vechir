...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Для каждого СтрокаТЧ из ДанныеОтчета Цикл
		Если СтрокаТЧ.ТипДанных = "Плани закупівель" Тогда
			СтрокаТЧ.ТипДанных = "Планы закупок";
		КонецЕсли;
		Если СтрокаТЧ.ТипДанных = "Фактичні закупівлі" Тогда
			СтрокаТЧ.ТипДанных = "Фактические закупки";
		КонецЕсли;
	КонецЦикла;
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументЗакупки", НСтр("ru='Документ закупки';uk='Документ купівлі'"));
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьБезНДС", НСтр("ru='Без НДС';uk='Без ПДВ'"), Ложь, "ЧЦ=15; ЧДЦ=2", "Стоимость", НСтр("ru='Стоимость';uk='Вартість'"));
