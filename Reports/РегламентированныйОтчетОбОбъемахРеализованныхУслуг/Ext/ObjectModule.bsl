...
//    - код показателя по составу показателей;
...
НоваяФорма.ОписаниеОтчета     = "Затверджена наказом Держкомстату України від 24.06.2010 N 241";
НоваяФорма.ДатаНачалоДействия = '2011-01-01';
НоваяФорма.ДатаКонецДействия = '2014-12-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2012Год";
НоваяФорма.ОписаниеОтчета     = "Затверджена наказом Держкомстату України від 10.08.2012 N 345";
...
НоваяФорма.ОписаниеОтчета     = "Затверджена наказом Держстату України від 31.05.2022 № 119";
