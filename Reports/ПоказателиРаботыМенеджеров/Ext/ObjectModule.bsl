...
Функция СформироватьСтрокуПериода() Экспорт
	...
	Если ДатаНачала = '00010101000000' И ДатаКонца = '00010101000000' Тогда
		...
		ОписаниеПериода     = НСтр("ru='Период не установлен';uk='Період не встановлений'", КодЯзыкаПечать);

	Иначе

		Если ДатаНачала = '00010101000000' ИЛИ ДатаКонца = '00010101000000' Тогда

			ОписаниеПериода = НСтр("ru='Период: ';uk='Період: '", КодЯзыкаПечать) + Формат(ДатаНачала, "ДФ = ""дд.ММ.гггг""; ДП = ""...""") 
							+ " - "      + Формат(ДатаКонца, "ДФ = ""дд.ММ.гггг""; ДП = ""...""");

		Иначе

			Если ДатаНачала <= ДатаКонца Тогда
				ОписаниеПериода = НСтр("ru='Период: ';uk='Період: '", КодЯзыкаПечать) + ПредставлениеПериода(НачалоДня(ДатаНачала), КонецДня(ДатаКонца), "ФП = Истина");
			Иначе
				ОписаниеПериода = НСтр("ru='Неправильно задан период!';uk='Неправильно заданий період!'", КодЯзыкаПечать)
			КонецЕсли;
...
Процедура СформироватьОтчет(Таб) Экспорт
	...
	Если НЕ СобратьТекстЗапроса(Запрос) Тогда
		Предупреждение(НСтр("ru='Запрос не выполнен!';uk='Запит не виконано!'")); 
		Возврат;
	КонецЕсли;
...
Процедура СформироватьРасшифровкуПоказателя(Таб, ИмяПоказателя, Менеджер, ФлагВозврата) Экспорт
	...
	ИначеЕсли ИмяПоказателя = "ПроцентКИКонтрагентов"
		...
		Предупреждение(НСтр("ru='Расшифровка данного показателя содержится в отчете о контактной информации!';uk='Розшифровка цього показника міститься у звіті про контактну інформацію!'"));
		ФлагВозврата = Истина;
...
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Общая сумма выручки от продаж в ';uk='Загальна сума виторгу від продажів у'", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета;
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "СуммаПрибыли"; //СуммаПрибыли
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Сумма себестоимости проданных товаров в ';uk='Сума собівартості проданих товарів у '", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета;
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "СуммаРучныхСкидок"; //КоэффициентУдержанияПокупателей
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Сумма предоставленных ручных скидок в ';uk='Сума наданих ручних знижок у '", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета;
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоСделок"; //КоличествоСобытий
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число сделок';uk='Число угод'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоПервыхСделок"; //СуммаЗакрытияЗаказов
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число первичных сделок';uk='Число первинних угод'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "СреднееЧислоСделок"; //ВыполнениеЗаказов
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Среднее число сделок с клиентом';uk='Середнє число угод з клієнтом'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "СреднееЗначениеВыручки"; //СуммаВыручкиБезНДС
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Средняя сумма выручки от сделки в ';uk='Середня сума виторгу від угоди у '", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета;
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ПроцентКИКонтрагентов"; //ПроцентКИКонтрагентов
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Заполненность конт. данных покупателей (%)';uk='Заповненість конт. даних покупців (%)'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ПроцентКИКонтЛицКонтр"; //КИКонтЛицКонтр
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Заполненность конт. данных контактных лиц покупателей (%)';uk='Заповненість конт. даних контактних осіб покупців (%)'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ПроцентКИКонтактныхЛиц"; //КИКонтактныхЛиц
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Заполненность личных конт. данных контактных лиц (%)';uk='Заповненість особистих конт. даних контактних осіб (%)'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоЗаказов"; //ПолнотаБазыДанныхКонтактнойИнформации
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число выставленных заказов';uk='Кількість виставлених замовлень'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоОплаченныхЗаказов"; //СтадииПокупателей
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число оплаченных заказов';uk='Число оплачених замовлень'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоНеоплаченныхЗаказов"; //КоличествоДокументовПродажи
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число неоплаченных заказов';uk='Число неоплачених замовлень'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоЧастичноОплаченных";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число частично оплаченных заказов';uk='Число частково оплачених замовлень'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "СуммаДолга";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Сумма дебиторской задолженности в ';uk='Сума дебіторської заборгованості у '", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета;
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоДолжников";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число должников';uk='Число боржників'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "СрокЗадолженности";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Средний срок существования задолженности в днях';uk='Середній строк існування заборгованості в днях'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "СуммаПросроченногоДолга";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Сумма просроченной дебиторской задолженности в ';uk='Сума простроченої дебіторської заборгованості у '", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета;
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоПросрочившихДолжников";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число должников, с просроченной задолженностью';uk='Число боржників, з простроченою заборгованістю'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоДнейПросрочки";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Среднее число дней просрочки';uk='Середня кількість днів прострочення'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ЧислоСобытий";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Число завершенных событий';uk='Число завершених подій'", КодЯзыкаПечать);
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ДлительностьСобытий";
СтрокаПоказателя.ПредставлениеПоказателя = НСтр("ru='Длительность завершенных событий (мин.)';uk='Тривалість завершених подій (хв.)'", КодЯзыкаПечать);
...
ПоказателиРасшифровки.Добавить("Характеристика", НСтр("ru='Характеристика номенклатуры';uk='Характеристика номенклатури'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("Стоимость", НСтр("ru='Сумма реализации (';uk='Сума реалізації ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
ПоказателиРасшифровки.Добавить("Себестоимость", НСтр("ru='Сумма себестоимости (';uk='Сума собівартості ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
ПоказателиРасшифровки.Добавить("Процент", НСтр("ru='Скидка в процентном выражении';uk='Знижка у відсотковому вираженні'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("Скидка", НСтр("ru='Сумма скидки (';uk='Сума знижки ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
ПоказателиРасшифровки.Добавить("Выручка", НСтр("ru='Сумма выручки от сделки (';uk='Сума виторгу від угоди ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
ПоказателиРасшифровки.Добавить("Всего", НСтр("ru='Общее число сделок';uk='Загальне число угод'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("Первичных", НСтр("ru='Число первичных сделок';uk='Число первинних угод'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("Оплата", НСтр("ru='Состояние оплаты';uk='Стан оплати'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("КОплате", НСтр("ru='Сумма к оплате (';uk='Сума до оплати ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
ПоказателиРасшифровки.Добавить("Оплачено", НСтр("ru='Оплачено на сумму (';uk='Оплачено на суму ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
ПоказателиРасшифровки.Добавить("Отгрузка", НСтр("ru='Состояние отгрузки';uk='Стан відвантаження'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("КОтгрузке", НСтр("ru='Количество единиц к отгрузке';uk='Кількість одиниць до відвантаження'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("Отгружено", НСтр("ru='Фактически отгружено единиц';uk='Фактично відвантажено одиниць'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("ДнейСМоментаУчета", НСтр("ru='Число дней с момента учета';uk='Число днів з моменту обліку'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("Движение", НСтр("ru='Вид движения';uk='Вид руху'", КодЯзыкаПечать));
ПоказателиРасшифровки.Добавить("НаСумму", НСтр("ru='Сумма операции (';uk='Сума операції ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
ПоказателиРасшифровки.Добавить("Задолженность", НСтр("ru='Сумма задолженности (';uk='Сума заборгованості ('", КодЯзыкаПечать) + мНаименованиеВалютыУпрУчета + ")");
