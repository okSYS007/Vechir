...
Функция ЗаголовокОтчета() Экспорт
	Если ЗначениеЗаполнено(Счет) Тогда
		Возврат  НСтр("ru='Оборотно-сальдовая ведомость по счету ';uk='Оборотно-сальдова відомість по рахунку '") + Счет;		
	Иначе
		Возврат  НСтр("ru='Оборотно-сальдовая ведомость по счету <не выбран счет>';uk='Оборотно-сальдова відомість по рахунку <не обраний рахунок>'");		
	КонецЕсли;	
