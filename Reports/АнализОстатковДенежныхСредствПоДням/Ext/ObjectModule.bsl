...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ЗаполнитьПоказатели("ТекущийОстаток_ВВалютеДенСредств", НСтр("ru='Остаток в валюте банковского счета/кассы';uk='Залишок у валюті банківського рахунку/каси'", КодЯзыкаПечать), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	ЗаполнитьПоказатели("СуммаКСписанию_ВВалютеДенСредств", НСтр("ru='К списанию в валюте банковского счета/кассы';uk='До списання у валюті банківського рахунку/каси'", КодЯзыкаПечать), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	ЗаполнитьПоказатели("СуммаКПолучению_ВВалютеДенСредств", НСтр("ru='К получению в валюте банковского счета/кассы';uk='До отримання у валюті банківського рахунку/каси'", КодЯзыкаПечать), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	ЗаполнитьПоказатели("СуммаВРезерве_ВВалютеДенСредств", НСтр("ru='В резерве в валюте банковского счета/кассы';uk='В резерві у валюті банківського рахунку/каси'", КодЯзыкаПечать), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	ЗаполнитьПоказатели("СуммаСвободныйОстатокВВалютеДенСредств", НСтр("ru='Ожидаемый остаток в валюте банковского счета/кассы';uk='Очікуваний залишок у валюті банківського рахунку/каси'", КодЯзыкаПечать), Истина, "ЧЦ = 15 ; ЧДЦ = 2");
	
	мРежимВводаПериода = 0;
	мНазваниеОтчета = НСтр("ru='Анализ доступности денежных средств по дням';uk='Аналіз доступності грошових коштів по днях'", КодЯзыкаПечать);
	...
	СтруктураПредставлениеПолей.Вставить("Период", НСтр("ru='Период';uk='Період'", КодЯзыкаПечать));
	СтруктураПредставлениеПолей.Вставить("БанковскийСчетКасса", НСтр("ru='Банковский счет/касса';uk='Банківський рахунок/каса'", КодЯзыкаПечать));
