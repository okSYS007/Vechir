...
Функция ПолучитьВыборкуДляВыгрузкиОчисткиДанных(Свойства, ИмяТипа, 
	...
	Если ВыборкаДляОчисткиДанных Тогда
		Состояние(НСтр("ru='Очистка ';uk='Очищення '") + ИмяТипа + ":  " + Свойства.Имя);
	Иначе
		Состояние(НСтр("ru='Выгрузка ';uk='Вивантаження '") + ИмяТипа + ":  " + Свойства.Имя);
	КонецЕсли;
	#КонецЕсли
	...
	Попытка
		...
		Пока ФайлОбмена.Прочитать() Цикл
			...
			ИначеЕсли ИмяУзла = "УдалениеОбъекта" Тогда
				...
				ОбработатьОкончаниеЧтенияНовогоЭлемента(НСтр("ru='Удаление объекта';uk=""Вилучення об'єкта"""));
...
Процедура ИнициализацияСообщений()
	...
	одСообщения.Вставить(7,  НСтр("ru='Не указано имя файла с правилами обмена (Имя файла правил)';uk=""Не вказано ім'я файлу з правилами обміну (Ім'я файлу правил)"""));
	...
	одСообщения.Вставить(13, НСтр("ru='Ошибка получения значения свойства подчиненного объекта (по имени свойства источника)';uk=""Помилка одержання значення властивості підпорядкованого об'єкта (по імені властивості джерела)"""));
	одСообщения.Вставить(14, НСтр("ru='Ошибка получения значения свойства подчиненного объекта (по имени свойства приемника)';uk=""Помилка одержання значення властивості підпорядкованого об'єкта (по імені властивості приймача)"""));
	
	одСообщения.Вставить(15, НСтр("ru='Ошибка в обработчике события ПередЗагрузкойОбъекта';uk='Помилка в обробнику події ПередЗагрузкойОбъекта'"));
			
	одСообщения.Вставить(16, НСтр("ru='Ошибка в обработчике события ПослеЗагрузкиОбъекта';uk='Помилка в обробнику події ПослеЗагрузкиОбъекта'"));
	одСообщения.Вставить(17, НСтр("ru='Ошибка в обработчике события ПередЗагрузкойДанных (конвертация)';uk='Помилка в обробнику події ПередЗагрузкойДанных (конвертація)'"));
		
	одСообщения.Вставить(19, НСтр("ru='Ошибка при удалении объекта';uk=""Помилка при вилученні об'єкта"""));
	...
	одСообщения.Вставить(22, НСтр("ru='Ошибка в обработчике события ПередОбработкойПравилаОчистки';uk='Помилка в обробнику події ПередОбработкойПравилаОчистки'"));
	одСообщения.Вставить(23, НСтр("ru='Ошибка в обработчике события ПослеОбработкиПравилаОчистки';uk='Помилка в обробнику події ПослеОбработкиПравилаОчистки'"));
	одСообщения.Вставить(24, НСтр("ru='Ошибка в обработчике события ПередУдалениемОбъекта';uk='Помилка в обробнику події ПередУдалениемОбъекта'"));
	одСообщения.Вставить(25, НСтр("ru='Ошибка при записи документа';uk='Помилка при записі документа'"));
	одСообщения.Вставить(26, НСтр("ru='Ошибка в обработчике события ПередОбработкойПравилаВыгрузки';uk='Помилка в обробнику події ПередОбработкойПравилаВыгрузки'"));
	одСообщения.Вставить(27, НСтр("ru='Ошибка в обработчике события ПослеОбработкиПравилаВыгрузки';uk='Помилка в обробнику події ПослеОбработкиПравилаВыгрузки'"));
	одСообщения.Вставить(28, НСтр("ru='Ошибка в обработчике события ПередВыгрузкойОбъекта';uk='Помилка в обробнику події ПередВыгрузкойОбъекта'"));
	одСообщения.Вставить(29, НСтр("ru='Ошибка в обработчике события ПослеВыгрузкиОбъекта';uk='Помилка в обробнику події ПослеВыгрузкиОбъекта'"));
	...
	одСообщения.Вставить(34, НСтр("ru='Ошибка в обработчике события ПриВыгрузкеОбъекта';uk='Помилка в обробнику події ПриВыгрузкеОбъекта'"));
	...
	одСообщения.Вставить(42, НСтр("ru='Ошибка в обработчике события ПередОбработкойВыгрузки группы свойств';uk='Помилка в обробнику події ПередОбработкойВыгрузки групи властивостей'"));
	...
	одСообщения.Вставить(48, НСтр("ru='Ошибка в глобальном обработчике события ПередЗагрузкойОбъекта (конвертация)';uk='Помилка в глобальному обробнику події ПередЗагрузкойОбъекта (конвертація)'"));
	одСообщения.Вставить(49, НСтр("ru='Ошибка в глобальном обработчике события ПослеЗагрузкиОбъекта (конвертация)';uk='Помилка в глобальному обробнику події ПослеЗагрузкиОбъекта (конвертація)'"));
	...
	одСообщения.Вставить(52, НСтр("ru='Ошибка в обработчике события ПослеВыгрузки (свойства)';uk='Помилка в обробнику події ПослеВыгрузки (властивості)'"));
	...
	одСообщения.Вставить(55, НСтр("ru='Ошибка в обработчике события ПослеВыгрузкиДанных (конвертация)';uk='Помилка в обробнику події ПослеВыгрузкиДанных (конвертація)'"));
	одСообщения.Вставить(56, НСтр("ru='Ошибка в глобальном обработчике события ПередКонвертациейОбъекта (конвертация)';uk='Помилка в глобальному обробнику події ПередКонвертациейОбъекта (конвертація)'"));
	одСообщения.Вставить(57, НСтр("ru='Ошибка в глобальном обработчике события ПередВыгрузкойОбъекта (конвертация)';uk='Помилка в глобальному обробнику події ПередВыгрузкойОбъекта (конвертація)'"));
	
	одСообщения.Вставить(62, НСтр("ru='Ошибка получения свойства подчиненного объекта из входящих данных ';uk=""Помилка отримання властивості підпорядкованого об'єкта з вхідних даних """));
	одСообщения.Вставить(63, НСтр("ru='Ошибка получения свойства объекта из входящих данных ';uk=""Помилка отримання властивості об'єкта з вхідних даних """));
	...
	одСообщения.Вставить(65, НСтр("ru='Ошибка в глобальном обработчике события ПослеВыгрузкиОбъекта (конвертация)';uk='Помилка в глобальному обробнику події ПослеВыгрузкиОбъекта (конвертація)'"));
	одСообщения.Вставить(66, НСтр("ru='Ошибка получения коллекции подчиненных объектов из входящих данных ';uk=""Помилка отримання колекції підпорядкованих об'єктів з вхідних даних """));
	...
	одСообщения.Вставить(68, НСтр("ru='Ошибка получения свойства объекта из входящих данных ';uk=""Помилка отримання властивості об'єкта з вхідних даних """));
	...
	одСообщения.Вставить(72, НСтр("ru='Ошибка в обработчике события ПослеЗагрузкиПравилОбмена (конвертация)';uk='Помилка в обробнику події ПослеЗагрузкиПравилОбмена (конвертація)'"));
	
	одСообщения.Вставить(73, НСтр("ru='Ошибка в обработчике события ПриПолученииИнформацииОбУдалении (конвертация)';uk='Помилка в обробнику події ПриПолученииИнформацииОбУдалении (конвертація)'"));	
	...
	одСообщения.Вставить(75, НСтр("ru='Ошибка в обработчике события ПослеЗагрузкиПравилОбмена (конвертация)';uk='Помилка в обробнику події ПослеЗагрузкиПравилОбмена (конвертація)'"));
	...
	одСообщения.Вставить(77, НСтр("ru='Ошибка в обработчике события ПриПолученииИнформацииОбУдалении (конвертация)';uk='Помилка в обробнику події ПриПолученииИнформацииОбУдалении (конвертація)'"));
	...
	одСообщения.Вставить(79, НСтр("ru='Ошибка в обработчике события ПослеВыгрузкиОбъектаВФайл';uk='Помилка в обробнику події ПослеВыгрузкиОбъектаВФайл'"));
	...
	одСообщения.Вставить(175, НСтр("ru='Ошибка в обработчике события ПередПолучениемИзмененныхОбъектов (конвертация)';uk='Помилка в обробнику події ПередПолучениемИзмененныхОбъектов (конвертація)'"));
	одСообщения.Вставить(176, НСтр("ru='Ошибка в обработчике события ПослеПолученияИнформацииОбУзлахОбмена (конвертация)';uk='Помилка в обробнику події ПослеПолученияИнформацииОбУзлахОбмена (конвертація)'"));
