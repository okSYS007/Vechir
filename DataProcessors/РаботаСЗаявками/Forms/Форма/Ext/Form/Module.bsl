...
Процедура ОбновитьТаблицуЭтаповСогласования(Заявка)
	...
	Запрос.Текст =    "ВЫБРАТЬ
	                  |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.ДатаСогласования,
	                  |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.РезультатСогласования,
	                  |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.Рецензент КАК Ответственный,
	                  |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.ТочкаМаршрута.Порядок КАК Индекс,
	                  |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.ТочкаМаршрута,
	                  |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.Комментарий
	                  |ИЗ
	                  |	БизнесПроцесс.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.РезультатыСогласования КАК СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования
	                  |ГДЕ
	                  |	СогласованиеЗаявкиНаРасходованиеДенежныхСредствРезультатыСогласования.Ссылка.Предмет = &Предмет";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    Запрос = новый запрос;
	Запрос.Текст =    "ВЫБРАТЬ
	                  |	СогласованиеТабеляУчетаВремениРезультатыСогласования.ДатаСогласования,
	                  |	СогласованиеТабеляУчетаВремениРезультатыСогласования.РезультатСогласования,
	                  |	СогласованиеТабеляУчетаВремениРезультатыСогласования.Рецензент КАК Ответственный,
	                  |	СогласованиеТабеляУчетаВремениРезультатыСогласования.ТочкаМаршрута.Порядок КАК Индекс,
	                  |	СогласованиеТабеляУчетаВремениРезультатыСогласования.ТочкаМаршрута,
	                  |	СогласованиеТабеляУчетаВремениРезультатыСогласования.Комментарий
	                  |ИЗ
	                  |	БизнесПроцесс.СогласованиеТабеляУчетаВремени.РезультатыСогласования КАК СогласованиеТабеляУчетаВремениРезультатыСогласования
	                  |ГДЕ
	                  |	СогласованиеТабеляУчетаВремениРезультатыСогласования.Ссылка.Предмет = &Предмет";
	Запрос.УстановитьПараметр("Предмет",Заявка);  
	...
	СогласованиеТебльУчетаРабочегоВремени.Загрузить(РезультатЗапроса);
	
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    Запрос = новый запрос;
	Запрос.Текст =    "ВЫБРАТЬ
	                  |	СогласованиеВедомостиВыработкиРезультатыСогласования.ДатаСогласования,
	                  |	СогласованиеВедомостиВыработкиРезультатыСогласования.РезультатСогласования,
	                  |	СогласованиеВедомостиВыработкиРезультатыСогласования.Рецензент КАК Ответственный,
	                  |	СогласованиеВедомостиВыработкиРезультатыСогласования.ТочкаМаршрута.Порядок КАК Индекс,
	                  |	СогласованиеВедомостиВыработкиРезультатыСогласования.ТочкаМаршрута,
	                  |	СогласованиеВедомостиВыработкиРезультатыСогласования.Комментарий
	                  |ИЗ
	                  |	БизнесПроцесс.СогласованиеВедомостиВыработки.РезультатыСогласования КАК СогласованиеВедомостиВыработкиРезультатыСогласования
	                  |ГДЕ
	                  |	СогласованиеВедомостиВыработкиРезультатыСогласования.Ссылка.Предмет = &Предмет";
	Запрос.УстановитьПараметр("Предмет",Заявка);  
	...
	СогласованиеВедомостьВыработки.Загрузить(РезультатЗапроса);
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    Запрос = новый запрос;
	Запрос.Текст =    "ВЫБРАТЬ
	                  |	СогласованиеНачисленияЗарплатыРезультатыСогласования.ДатаСогласования,
	                  |	СогласованиеНачисленияЗарплатыРезультатыСогласования.РезультатСогласования,
	                  |	СогласованиеНачисленияЗарплатыРезультатыСогласования.Рецензент КАК Ответственный,
	                  |	СогласованиеНачисленияЗарплатыРезультатыСогласования.ТочкаМаршрута.Порядок КАК Индекс,
	                  |	СогласованиеНачисленияЗарплатыРезультатыСогласования.ТочкаМаршрута,
	                  |	СогласованиеНачисленияЗарплатыРезультатыСогласования.Комментарий
	                  |ИЗ
	                  |	БизнесПроцесс.СогласованиеНачисленияЗарплаты.РезультатыСогласования КАК СогласованиеНачисленияЗарплатыРезультатыСогласования
	                  |ГДЕ
	                  |	СогласованиеНачисленияЗарплатыРезультатыСогласования.Ссылка.Предмет = &Предмет";
	Запрос.УстановитьПараметр("Предмет",Заявка);  
	...
	СогласованиеВедомостьНачисленияЗП.Загрузить(РезультатЗапроса);
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    Запрос = новый запрос;
	Запрос.Текст =    "ВЫБРАТЬ
	                  |	СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования.ДатаСогласования,
	                  |	СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования.РезультатСогласования,
	                  |	СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования.Рецензент КАК Ответственный,
	                  |	СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования.ТочкаМаршрута.Порядок КАК Индекс,
	                  |	СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования.ТочкаМаршрута,
	                  |	СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования.Комментарий
	                  |ИЗ
	                  |	БизнесПроцесс.СогласованиеСводногоНачисленияЗарплаты.РезультатыСогласования КАК СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования
	                  |ГДЕ
	                  |	СогласованиеСводногоНачисленияЗарплатыРезультатыСогласования.Ссылка.Предмет = &Предмет";
	Запрос.УстановитьПараметр("Предмет",Заявка);  
	...
	СогласованиеСводнаяВедомость.Загрузить(РезультатЗапроса);
	...
	СогласованиеОбходнойЛист.Загрузить(РезультатЗапроса);
...
Процедура ОбновитьЗадачи()
	...
	Элементы.ЗадачиПоЗаявкеТабльУчетаВремени.Обновить();
	Элементы.ЗадачиПоВедомостиВыработки.Обновить();
	Элементы.ЗадачиПоВедомостиНачисленияЗП.Обновить();
	Элементы.ЗадачиСводнаяВедомость.Обновить();
...
Процедура ОбновитьСписок(Команда)
	...
	Элементы.ВедомостиВыработки.Обновить();
	Элементы.ТабеляУчетаРабочегоВремени.Обновить();
	Элементы.ВедомостьНачисленияЗП.Обновить();
	Элементы.СводнаяВедомостьНачисленияЗП.Обновить();
	Элементы.ОбходныеЛисты.Обновить();

	Если Элементы.РазделыСогласования.ТекущаяСтраница = Элементы.ГруппаЗявкиСтруктураСогласование Тогда 
		ДокументСсылка = Элементы.Заявки.ТекущаяСтрока;
		ВывестиСтруктуруПодчиненности();
	ИначеЕсли Элементы.РазделыСогласования.ТекущаяСтраница = Элементы.СогласованиеТабеляУчетаРабочегоВремени Тогда
		ДокументСсылка = Элементы.ТабеляУчетаРабочегоВремени.ТекущаяСтрока;
		ВывестиСтруктуруПодчиненности();	
	ИначеЕсли Элементы.РазделыСогласования.ТекущаяСтраница = Элементы.СогласованиеВедомостиВыработки Тогда
		ДокументСсылка = Элементы.ВедомостиВыработки.ТекущаяСтрока;
		ВывестиСтруктуруПодчиненности();
	ИначеЕсли Элементы.РазделыСогласования.ТекущаяСтраница = Элементы.СогласованиеВедомостьНачисленияЗП Тогда
		ДокументСсылка = Элементы.ВедомостьНачисленияЗП.ТекущаяСтрока;
		ВывестиСтруктуруПодчиненности();
	ИначеЕсли Элементы.РазделыСогласования.ТекущаяСтраница = Элементы.СогласованиеСводнаяВедомостьГруппа Тогда
		ДокументСсылка = Элементы.СводнаяВедомостьНачисленияЗП.ТекущаяСтрока;
		ВывестиСтруктуруПодчиненности();	
	ИначеЕсли Элементы.РазделыСогласования.ТекущаяСтраница = Элементы.СогласованиеКадровыхДокументов Тогда
...
Процедура ОбновитьФорму() Экспорт           
    ...
    ОбновитьТаблицуЭтаповСогласования(Элементы.Заявки.ТекущаяСтрока);
...
Процедура ПриОткрытии(Отказ)
	...
	//
	//ВыполнитьОбновлениеДереваДокументов();
	ЗадачиПользоваетля.Параметры.УстановитьЗначениеПараметра("Выполнена", Ложь);
// н ЛИВ
	ЗадачиПользоваетля.Параметры.УстановитьЗначениеПараметра("ТекущийПользователь", глЗначениеПеременной("глТекущийПользователь"));
// к ЛИВ

	Если РольДоступнаНаСервере("ДоступКТабелюУчетаРабочегоВремени") Тогда 
		Элементы.СогласованиеТабеляУчетаРабочегоВремени.Видимость = Истина;
	Иначе
		Элементы.СогласованиеТабеляУчетаРабочегоВремени.Видимость = Ложь;
	КонецЕсли;
	
	Если РольДоступнаНаСервере("ДоступКВедомостиВыработки") Тогда 
		Элементы.СогласованиеВедомостиВыработки.Видимость = Истина;
	Иначе
		Элементы.СогласованиеВедомостиВыработки.Видимость = Ложь;
	КонецЕсли;                                                                    
	
	Если РольДоступнаНаСервере("ДоступКНачислениюЗП") Тогда 
		Элементы.СогласованиеВедомостьНачисленияЗП.Видимость = Истина;
	Иначе
		Элементы.СогласованиеВедомостьНачисленияЗП.Видимость = Ложь;
	КонецЕсли;
	
	Если РольДоступнаНаСервере("ДоступКСводнойВедомости") Тогда 
		Элементы.СогласованиеСводнаяВедомостьГруппа.Видимость = Истина;
	Иначе
		Элементы.СогласованиеСводнаяВедомостьГруппа.Видимость = Ложь;
	КонецЕсли;
	
	Если РольДоступнаНаСервере("ДоступКадровымДокументам") Тогда 
		Элементы.СогласованиеКадровыхДокументов.Видимость = Истина;
	Иначе
		Элементы.СогласованиеКадровыхДокументов.Видимость = Ложь;
	КонецЕсли;
...
Процедура Файлы(Команда)
	...
	ФормаФайлов.Изображения.Отбор.Объект.Значение                                    = Элементы.Заявки.ТекущаяСтрока;
	...
	ФормаФайлов.ДополнительныеФайлы.Отбор.Объект.Значение                            = Элементы.Заявки.ТекущаяСтрока;
	...
	ОбязательныеОтборы.Вставить("Объект",Элементы.Заявки.ТекущаяСтрока);
...
// t.me/konstantyn_buhantsev [3 квітня 2025 р.] --> 
&НаКлиенте
Процедура Нераспределенные(Команда)
	
	ВидСравненияФ = ВидСравненияКомпоновкиДанных.Равно;
    ИмяПоляФ = "ЦФО";
    ЗначениеОтбораФ = Справочники.Подразделения.ПустаяСсылка();
	
	СуществующийЭлементОтбора = Неопределено;
	
    Для Каждого ЭлементОтбора Из Заявки.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы Цикл
        
        Если ТипЗнч(ЭлементОтбора) = Тип("ОтборКомпоновкиДанных") Тогда
            
            ПользовательскийОтбор = ЭлементОтбора.Элементы;
            
            Для Каждого СуществующийЭлемент Из ПользовательскийОтбор Цикл
                
                Если СуществующийЭлемент.ЛевоеЗначение = Новый ПолеКомпоновкиДанных(ИмяПоляФ) Тогда
                    
                    СуществующийЭлементОтбора = СуществующийЭлемент;
                    Прервать;
	...
	Если НЕ СуществующийЭлементОтбора = Неопределено Тогда
		ПользовательскийОтбор.Удалить(СуществующийЭлементОтбора);	
		Элементы.ЗаявкиНераспределенные.Картинка = БиблиотекаКартинок.Поиск;
	Иначе
		Элементы.ЗаявкиНераспределенные.Картинка = БиблиотекаКартинок.ОтменитьПоиск;
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура ТабеляУчетаРабочегоВремениПриАктивизацииСтроки(Элемент)

	Попытка
		ДокументСсылка = Элемент.ТекущиеДанные.ссылка;
	Исключение
		ДокументСсылка = Документы.ТабельУчетаРабочегоВремениУправленческий.ПустаяСсылка();	
	КонецПопытки;
	ВывестиСтруктуруПодчиненности();
	ОбновитьТаблицуЭтаповСогласования(ДокументСсылка);
	ОбновитьЗадачи();
...
&НаКлиенте
Процедура ЗадачиПоЗаявкеТабльУчетаВремениВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ФормаДокумента = Элементы.ЗадачиПоЗаявкеТабльУчетаВремени.ТекущаяСтрока.Предмет.ПолучитьФорму();
	ФормаДокумента.ОткрытьМодально();
...
////////////////Запуск в работу Заявки на расходование средств//////////////////////////////////
&НаКлиенте
Процедура ЗапуститьВРаботу(Команда)
	
	Если Элементы.Заявки.ТекущиеДанные.ссылка.Проведен тогда
		
		
		Если ЕстьФайлы( Элементы.Заявки.ТекущаяСтрока) или ПроходитПоСумме(Элементы.Заявки.ТекущиеДанные.ссылка)  Тогда 
			
			УспешныйЗапуск = ЗапуститьВРаботуНаСервере(Элементы.Заявки.ТекущаяСтрока);
			
			Если УспешныйЗапуск Тогда 
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Заявка № "+Элементы.Заявки.ТекущиеДанные.Номер+" успішно відправлена на погодження!");	
			КонецЕсли;
	...
	Иначе
		...
		Сообщить("Ви не можете запустити в роботу непроведений документ!",СтатусСообщения.ОченьВажное);
...
Функция ЗапуститьВРаботуНаСервере(Заявка)
	...
	Запрос = новый запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               |	СогласованиеЗаявкиНаРасходованиеДенежныхСредств.Ссылка
	               |ИЗ
	               |	БизнесПроцесс.СогласованиеЗаявкиНаРасходованиеДенежныхСредств КАК СогласованиеЗаявкиНаРасходованиеДенежныхСредств
	               |ГДЕ
	               |	СогласованиеЗаявкиНаРасходованиеДенежныхСредств.Предмет = &Предмет
	               |	И НЕ СогласованиеЗаявкиНаРасходованиеДенежныхСредств.ПометкаУдаления";
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда 
		...
		Если Заявка.Статус = Перечисления.СтатусыЗаявокНаРасходованиеДенежныхСредств.Черновик Тогда
			
			пСогласование = РезультатЗапроса.Выгрузить()[0].Ссылка.ПолучитьОбъект();
			пСогласование.Удалить();
			
			БизнесПроцесс = БизнесПроцессы.СогласованиеЗаявкиНаРасходованиеДенежныхСредств.СоздатьБизнесПроцесс();
			БизнесПроцесс.Заполнить(Заявка); 
			БизнесПроцесс.Дата = Заявка.дата;
			БизнесПроцесс.Записать();
			БизнесПроцесс.Старт(); 
			
			ЗаявкаОб = Заявка.ПолучитьОбъект();
			ЗаявкаОб.Статус = Перечисления.СтатусыЗаявокНаРасходованиеДенежныхСредств.НаСогласовании;
			ЗаявкаОб.записать();
	...
	ИначеЕсли Заявка.Статус = Перечисления.СтатусыЗаявокНаРасходованиеДенежныхСредств.Согласована
		или Заявка.Статус = Перечисления.СтатусыЗаявокНаРасходованиеДенежныхСредств.Отклонена Тогда 
...
////////////////Запуск в работу Табель учета//////////////////////////////////
&НаКлиенте
Процедура ЗапуститьВРаботуТабель(Команда)
	Если Элементы.ТабеляУчетаРабочегоВремени.ТекущиеДанные.ссылка.Проведен тогда
		
		УспешныйЗапуск = ЗапуститьТабельВРаботуНаСервере(Элементы.ТабеляУчетаРабочегоВремени.ТекущаяСтрока);
		
		Если УспешныйЗапуск Тогда 
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Табель № "+Элементы.ТабеляУчетаРабочегоВремени.ТекущиеДанные.Номер+" успішно відправлена на погодження!");	
		КонецЕсли;
...
&НаСервере 
Функция ЗапуститьТабельВРаботуНаСервере(Табель)
	
	Запрос = новый запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               |	СогласованиеТабеляУчетаВремени.Ссылка
	               |ИЗ
	               |	БизнесПроцесс.СогласованиеТабеляУчетаВремени КАК СогласованиеТабеляУчетаВремени
	               |ГДЕ
	               |	СогласованиеТабеляУчетаВремени.Предмет = &Предмет";
	
	Запрос.УстановитьПараметр("Предмет",Табель); 
	РезультатЗапроса = Запрос.Выполнить().Выгрузить();
	
	Если РезультатЗапроса.Количество() Тогда 
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Процесс согласования уже запущен"); 
		
	ИначеЕсли Табель.Статус = Перечисления.СтатусыТабеляУчетаРабочегоВремени.Согласован
		или Табель.Статус = Перечисления.СтатусыТабеляУчетаРабочегоВремени.НеСогласован Тогда 
	...
	Иначе
		...
		БизнесПроцесс = БизнесПроцессы.СогласованиеТабеляУчетаВремени.СоздатьБизнесПроцесс();
		БизнесПроцесс.Заполнить(Табель); 
		БизнесПроцесс.Дата = Табель.дата;
		БизнесПроцесс.Записать();
		БизнесПроцесс.Старт(); 
		
		ТабельОб = Табель.ПолучитьОбъект();
		ТабельОб.Статус = Перечисления.СтатусыТабеляУчетаРабочегоВремени.НаСогласовании;
		ТабельОб.записать();
...
&НаСервере 
Функция ЗапуститьТабельВОбходнойЛистНаСервере(ОбходнойЛист)
	...
	ИначеЕсли ОбходнойЛист.Статус = Перечисления.СтатусыОбходныхЛистов.Согласован
		или ОбходнойЛист.Статус = Перечисления.СтатусыОбходныхЛистов.НеСогласован Тогда 
	...
	Иначе
		...
		ТабельОб = ОбходнойЛист.ПолучитьОбъект();
		ТабельОб.Статус = Перечисления.СтатусыОбходныхЛистов.НаСогласовании;
		ТабельОб.записать();
...
////////////////Запуск в работу Ведомость выработки//////////////////////////////////
&НаКлиенте
Процедура ЗапуститьВРаботуВедомостьВыработки(Команда)
	Если Элементы.ВедомостиВыработки.ТекущиеДанные.ссылка.Проведен тогда
		
		УспешныйЗапуск = ЗапуститьВРаботуВедомостьВыработкиНаСервере(Элементы.ВедомостиВыработки.ТекущаяСтрока);
		
		Если УспешныйЗапуск Тогда 
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Відомість виробітку № "+Элементы.ВедомостиВыработки.ТекущиеДанные.Номер+" успішно відправлена на погодження!");	
		КонецЕсли;
...
&НаСервере 
Функция ЗапуститьВРаботуВедомостьВыработкиНаСервере(ВедомостьВыработки)
	
	Запрос = новый запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               |	СогласованиеВедомостиВыработки.Ссылка
	               |ИЗ
	               |	БизнесПроцесс.СогласованиеВедомостиВыработки КАК СогласованиеВедомостиВыработки
	               |ГДЕ
	               |	СогласованиеВедомостиВыработки.Предмет = &Предмет";
	
	Запрос.УстановитьПараметр("Предмет",ВедомостьВыработки); 
	РезультатЗапроса = Запрос.Выполнить().Выгрузить();
	
	Если РезультатЗапроса.Количество() Тогда 
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Процесс согласования уже запущен"); 
		
	ИначеЕсли ВедомостьВыработки.Статус = Перечисления.СтатусыВедомостиВыработки.Согласован
		или ВедомостьВыработки.Статус = Перечисления.СтатусыВедомостиВыработки.НеСогласован Тогда 
	...
	Иначе
		...
		БизнесПроцесс = БизнесПроцессы.СогласованиеВедомостиВыработки.СоздатьБизнесПроцесс();
		БизнесПроцесс.Заполнить(ВедомостьВыработки); 
		БизнесПроцесс.Дата = ВедомостьВыработки.дата;
		БизнесПроцесс.Записать();
		БизнесПроцесс.Старт(); 
		
		ВедомостьВыработкиОб = ВедомостьВыработки.ПолучитьОбъект();
		ВедомостьВыработкиОб.Статус = Перечисления.СтатусыВедомостиВыработки.НаСогласовании;
		ВедомостьВыработкиОб.записать();
...
////////////////Запуск в работу Начисление ЗП//////////////////////////////////

&НаКлиенте
Процедура ЗапуститьВРаботуНачислениеЗП(Команда)
	
	Если Элементы.ВедомостьНачисленияЗП.ТекущиеДанные.ссылка.Проведен тогда
		
		УспешныйЗапуск = ЗапуститьВРаботуНачислениеЗПНаСервере(Элементы.ВедомостьНачисленияЗП.ТекущаяСтрока);
		
		Если УспешныйЗапуск Тогда 
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Відомість нарахування заробітньої плати № "+Элементы.ВедомостьНачисленияЗП.ТекущиеДанные.Номер+" успішно відправлена на погодження!");	
		КонецЕсли;
...
&НаСервере 
Функция ЗапуститьВРаботуНачислениеЗПНаСервере(НачислениеЗП)
	
	Запрос = новый запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               |	СогласованиеНачисленияЗарплаты.Ссылка
	               |ИЗ
	               |	БизнесПроцесс.СогласованиеНачисленияЗарплаты КАК СогласованиеНачисленияЗарплаты
	               |ГДЕ
	               |	СогласованиеНачисленияЗарплаты.Предмет = &Предмет";
	
	Запрос.УстановитьПараметр("Предмет",НачислениеЗП); 
	РезультатЗапроса = Запрос.Выполнить().Выгрузить();
	
	Если РезультатЗапроса.Количество() Тогда 
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Процесс согласования уже запущен"); 
		
	ИначеЕсли НачислениеЗП.Статус = Перечисления.СтатусыНачисленияЗаработнойПлаты.Согласован
		или НачислениеЗП.Статус = Перечисления.СтатусыНачисленияЗаработнойПлаты.НеСогласован Тогда 
	...
	Иначе
		...
		БизнесПроцесс = БизнесПроцессы.СогласованиеНачисленияЗарплаты.СоздатьБизнесПроцесс();
		БизнесПроцесс.Заполнить(НачислениеЗП); 
		БизнесПроцесс.Дата = НачислениеЗП.дата;
		БизнесПроцесс.Записать();
		БизнесПроцесс.Старт(); 
		
		НачислениеЗПОб = НачислениеЗП.ПолучитьОбъект();
		НачислениеЗПОб.Статус = Перечисления.СтатусыНачисленияЗаработнойПлаты.НаСогласовании;
		НачислениеЗПОб.записать();
...
////////////////Запуск в работу Сводную ведомость //////////////////////////////////

&НаКлиенте
Процедура ЗапуститьВРаботуСводнуюВедомость(Команда)
	Если Элементы.СводнаяВедомостьНачисленияЗП.ТекущиеДанные.ссылка.Проведен тогда
		
		УспешныйЗапуск = ЗапуститьВРаботуСводнуюНаСервере(Элементы.СводнаяВедомостьНачисленияЗП.ТекущаяСтрока);
		
		Если УспешныйЗапуск Тогда 
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Зведена відомість № "+Элементы.СводнаяВедомостьНачисленияЗП.ТекущиеДанные.Номер+" успішно відправлена на погодження!");	
		КонецЕсли;
...
&НаСервере 
Функция ЗапуститьВРаботуСводнуюНаСервере(СводнаяВедомость)
	
	Запрос = новый запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               |	СогласованиеСводногоНачисленияЗарплаты.Ссылка
	               |ИЗ
	               |	БизнесПроцесс.СогласованиеСводногоНачисленияЗарплаты КАК СогласованиеСводногоНачисленияЗарплаты
	               |ГДЕ
	               |	СогласованиеСводногоНачисленияЗарплаты.Предмет = &Предмет";
	
	Запрос.УстановитьПараметр("Предмет",СводнаяВедомость); 
	РезультатЗапроса = Запрос.Выполнить().Выгрузить();
	
	Если РезультатЗапроса.Количество() Тогда 
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Процесс согласования уже запущен"); 
		
	ИначеЕсли СводнаяВедомость.Статус = Перечисления.СтатусыСводногоНачисленияЗаработнойПлаты.Согласован
		или СводнаяВедомость.Статус = Перечисления.СтатусыСводногоНачисленияЗаработнойПлаты.НеСогласован Тогда 
	...
	Иначе
		...
		БизнесПроцесс = БизнесПроцессы.СогласованиеСводногоНачисленияЗарплаты.СоздатьБизнесПроцесс();
		БизнесПроцесс.Заполнить(СводнаяВедомость); 
		БизнесПроцесс.Дата = СводнаяВедомость.дата;
		БизнесПроцесс.Записать();
		БизнесПроцесс.Старт(); 
		
		СводнаяВедомостьЗПОб = СводнаяВедомость.ПолучитьОбъект();
		СводнаяВедомостьЗПОб.Статус = Перечисления.СтатусыСводногоНачисленияЗаработнойПлаты.НаСогласовании;
		СводнаяВедомостьЗПОб.записать();
...
&НаКлиенте
Процедура ВедомостиВыработкиПриАктивизацииСтроки(Элемент)
	
	Попытка
		ДокументСсылка = Элемент.ТекущиеДанные.ссылка;
	Исключение
		ДокументСсылка = Документы.ВедомостьВыработки.ПустаяСсылка();	
	КонецПопытки;
	ВывестиСтруктуруПодчиненности();
	ОбновитьТаблицуЭтаповСогласования(ДокументСсылка);
	ОбновитьЗадачи();
...
&НаКлиенте
Процедура ВедомостьНачисленияЗППриАктивизацииСтроки(Элемент)
	
	Попытка
		ДокументСсылка = Элемент.ТекущиеДанные.ссылка;
	Исключение
		ДокументСсылка = Документы.ВедомостьНачисленияЗарплаты.ПустаяСсылка();	
	КонецПопытки;
	ВывестиСтруктуруПодчиненности();
	ОбновитьТаблицуЭтаповСогласования(ДокументСсылка);
	ОбновитьЗадачи();
...
&НаКлиенте
Процедура СводнаяВедомостьНачисленияЗППриАктивизацииСтроки(Элемент)
	
	Попытка
		ДокументСсылка = Элемент.ТекущиеДанные.ссылка;
	Исключение
		ДокументСсылка = Документы.СводнаяВедомостьНачисленияЗарплаты.ПустаяСсылка();	
	КонецПопытки;
	ВывестиСтруктуруПодчиненности();
	ОбновитьТаблицуЭтаповСогласования(ДокументСсылка);
	ОбновитьЗадачи();
...
&НаКлиенте
Процедура ЗадачиПоЗаявкеВедомостьВыработкиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
		
	СтандартнаяОбработка = Ложь;
	ФормаДокумента = Элементы.ЗадачиПоВедомостиВыработки.ТекущаяСтрока.Предмет.ПолучитьФорму();
	ФормаДокумента.ОткрытьМодально();
...
&НаКлиенте
Процедура ЗадачиПоЗаявкеВедомостьНачисленияЗПВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
		
	СтандартнаяОбработка = Ложь;
	ФормаДокумента = Элементы.ЗадачиПоВедомостиНачисленияЗП.ТекущаяСтрока.Предмет.ПолучитьФорму();
	ФормаДокумента.ОткрытьМодально();
...
&НаКлиенте
Процедура ЗадачиСводнаяВедомостьВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
		
	СтандартнаяОбработка = Ложь;
	ФормаДокумента = Элементы.ЗадачиСводнаяВедомость.ТекущаяСтрока.Предмет.ПолучитьФорму();
	ФормаДокумента.ОткрытьМодально();
...
&НаКлиенте
Процедура ОбходныеЛистыПриАктивизацииСтроки(Элемент)
	Попытка
		ДокументСсылка = Элемент.ТекущиеДанные.ссылка;
	Исключение
		ДокументСсылка = Документы.ОбходнойЛист.стаяСсылка();	
	КонецПопытки;
	ВывестиСтруктуруПодчиненности();
	ОбновитьТаблицуЭтаповСогласования(ДокументСсылка);
	ОбновитьЗадачи();
...
&НаКлиенте
Процедура ЗапуститьВРаботуОбходнойЛист(Команда)
	Если Элементы.ОбходныеЛисты.ТекущиеДанные.ссылка.Проведен тогда
		
		
		//Если ЕстьФайлы( Элементы.Заявки.ТекущаяСтрока) или ПроходитПоСумме(Элементы.Заявки.ТекущиеДанные.ссылка)  Тогда 
			
			УспешныйЗапуск = ЗапуститьТабельВОбходнойЛистНаСервере(Элементы.ОбходныеЛисты.ТекущаяСтрока);
...
Процедура ПоказатьВсеЗадачи(Команда)
	Если ВсеЗадачи = ложь Тогда
		ЗадачиПользоваетля.Параметры.УстановитьЗначениеПараметра("Выполнена", Истина);
		ПоменятьИмяКоманды("Нові завдання");
		ВсеЗадачи = Истина;
	Иначе
		ЗадачиПользоваетля.Параметры.УстановитьЗначениеПараметра("Выполнена", Ложь);
		ПоменятьИмяКоманды("Старі завдання");
		ВсеЗадачи = Ложь;
	КонецЕсли;	
...
&НаСервере
Процедура ПоменятьИмяКоманды(НовыйЗаголовок)
	Команды.ПоказатьВсеЗадачи.Заголовок = НовыйЗаголовок;
КонецПроцедуры;	
