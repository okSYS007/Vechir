...
Процедура СообщитьОбИзмененияхВНастройкеАвтообмена(ТаблицаОбменов)
	...
	Для Каждого СтрокаТаблицы Из СохраненнаяТаблица Цикл
		...
		Если НайденнаяСтрока = Неопределено Тогда
			Сообщить(НСтр("ru='Из списка текущих автообменов удалена настройка ""';uk='Зі списку поточних автообмінів вилучена настройка ""'") + СтрокаТаблицы.Ссылка + """.");
			Продолжить;
		КонецЕсли;
	...
	Для Каждого СтрокаТаблицы Из ТаблицаОбменов Цикл
		...
		Если НайденнаяСтрока = Неопределено Тогда
			Сообщить(НСтр("ru='В список автоматического обмена данными добавлена новая настройка ""';uk='У список автоматичного обміну даними додана нова настройка ""'") + СтрокаТаблицы.Ссылка + """");
		КонецЕсли; 
...
Процедура ОбновитьНастройкуАвтоматическогоОбмена(Ссылка) Экспорт
	...
	Иначе
		...
		Если СтрокаТаблицы = Неопределено Тогда
			#Если Клиент Тогда
				Сообщить(НСтр("ru='Из списка текущих автообменов удалена настройка ""';uk='Зі списку поточних автообмінів вилучена настройка ""'") + СтрокаНастройкиОбмена.Ссылка + """.");
			#КонецЕсли	
