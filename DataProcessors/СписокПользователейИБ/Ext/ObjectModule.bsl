...
Процедура ЗаполнитьСписокПользователейИБ(ОтборСтрок) Экспорт
	...
	Для Каждого Пользователь Из Пользователи Цикл
		...
		Исключение
			ТекущиеДанные.ПользовательОС = НСтр("ru='<Неверные данные>';uk='<Невірні дані>'");
		КонецПопытки; 
...
Процедура ДописатьСтрокуОтбора(СтрокаОтбора, ЭлементОтбора)
	...
	ИначеЕсли ЭлементОтбора.ВидСравнения = ВидСравнения.ВСписке Тогда
		...
		КонецЦикла; 
		СтрокаОтбора = СтрокаОтбора + ЭлементОтбора.Представление + НСтр("ru=' в списке: ';uk=' у списку: '")+ СтрокаСписка;
	ИначеЕсли ЭлементОтбора.ВидСравнения = ВидСравнения.НеВСписке Тогда
		...
		Для Каждого ЭлементСписка Из ЭлементОтбора.Значение Цикл
			...
			СтрокаСписка = СтрокаСписка + СокрЛП(ЭлементСписка.Значение);
		КонецЦикла; 
		СтрокаОтбора = СтрокаОтбора + ЭлементОтбора.Представление + НСтр("ru=' не в списке: ';uk=' не в списку: '")+ СтрокаСписка;
	ИначеЕсли ЭлементОтбора.ВидСравнения = ВидСравнения.Содержит Тогда
		СтрокаОтбора = СтрокаОтбора + ЭлементОтбора.Представление + НСтр("ru=' содержит: ';uk=' містить: '")+ СокрЛП(ЭлементОтбора.Значение);
	КонецЕсли; 
