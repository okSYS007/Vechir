...
Процедура ЗаполнитьНачальныеНастройки(НачальноеЗаполнение = Истина) Экспорт
	...
	Иначе
		Если ВыбиратьСотрудника Тогда
			...
			|	РаботникиОрганизации.ЗанимаемыхСтавок					КАК занимаемыхСтавокУпр,
			|	РаботникиОрганизации.Должность							КАК ДолжностьУпр,
			////|	ДатаПриемаСотрудника.ДатаПриема КАК ДатаПриема,
			////|	РаботникиОрганизации.Подразделение КАК ПодразделениеОрганизации,
			|	РаботникиОрганизации.Подразделение 						КАК ПодразделениеУпр
			|ИЗ
	...
	СтруктураПредставлениеПолей.Вставить("Группа"				, НСтр("ru='Группа сотрудников';uk='Група співробітників'"));
	СтруктураПредставлениеПолей.Вставить("ГоловнаяОрганизация"	,	НСтр("ru='Организация';uk='Організація'"));
	
	Если РеглУчет Тогда 
		СтруктураПредставлениеПолей.Вставить("ВидЗанятости"	,			НСтр("ru='Вид занятости';uk='Вид зайнятості'"));
	КонецЕсли;
	СтруктураПредставлениеПолей.Вставить("Сотрудник",					НСтр("ru='Сотрудник';uk='Співробітник'"));
	...
	СтруктураПредставлениеПолей.Вставить("ЗанимаемыхСтавок",			НСтр("ru='Занимаемых ставок';uk='Займаних ставок'"));
	...
	СтруктураПредставлениеПолей.Вставить("Работник", 					НСтр("ru='Работник';uk='Працівник'"));
	...
	Если НачальноеЗаполнение Тогда
		...
		МассивОтбора.Добавить("ГоловнаяОрганизация");
