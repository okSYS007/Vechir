...
мСтруктураПредставленийОтборов.Вставить("ТипДокумента", НСтр("ru='Вид документа';uk='Вид документу'"));
мСписокОтборов.Добавить("Договор","СправочникСсылка.ДоговорыКонтрагентов");
мСтруктураПредставленийОтборов.Вставить("Договор", НСтр("ru='Договор контрагента';uk='Договір контрагента'"));
...
мСписокОтборов.Добавить("ОбщаяСуммаСделки","Число");
мСтруктураПредставленийОтборов.Вставить("ОбщаяСуммаСделки", НСтр("ru='Сумма сделки';uk='Сума угоди'"));
