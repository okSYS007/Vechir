...
Процедура ЗаполнитьСобытия(ОтображатьЗаказыПокупателя, ОтображатьЗаказыПоставщику) Экспорт
	...
	# Если Клиент Тогда
		Состояние(НСтр("ru='Выполняется заполнение событий списка ...';uk='Виконується заповнення подій списку ...'"));
	# КонецЕсли
...
Процедура СобратьДокументыМесяца(ОтображатьЗапланированныеСобытия = Ложь, ТипСобытияКалендаря, ОтображатьЗаказыПокупателя, ОтображатьЗаказыПоставщику) Экспорт
	...
	# Если Клиент Тогда
	Состояние(НСтр("ru='Выполняется заполнение документов месяца ...';uk='Виконується заповнення документів місяця ...'"));
	# КонецЕсли
...
Процедура СобратьДокументыНедели(ОтображатьЗапланированныеСобытия = Ложь, ТипСобытияКалендаря, ОтображатьЗаказыПокупателя, ОтображатьЗаказыПоставщику, ОтображатьЗанятостьПомещений) Экспорт
	Перем ВидСравненияПользователь;
	# Если Клиент Тогда
	Состояние(НСтр("ru='Выполняется заполнение документов недели и дня ...';uk='Виконується заповнення документів тижня і дня ...'"));
	# КонецЕсли
...
мСтруктураПредставленийОтборов.Вставить("Дата", НСтр("ru='Дата документа';uk='Дата документа'"));
мСтруктураПредставленийОтборов.Вставить("ДатаСобытия", НСтр("ru='Дата события';uk='Дата події'"));
...
мСтруктураПредставленийОтборов.Вставить("КонтактноеЛицо", НСтр("ru='Физическое лицо';uk='Фізична особа'"));
...
мСтруктураПредставленийОтборов.Вставить("Важность", НСтр("ru='Важность события';uk='Важливість події'"));
мСписокОтборов.Добавить("Тип","ПеречислениеСсылка.ВходящееИсходящееСобытие");
мСтруктураПредставленийОтборов.Вставить("Тип", НСтр("ru='Тип события';uk='Тип події'"));
мСписокОтборов.Добавить("Номер","Строка");
мСтруктураПредставленийОтборов.Вставить("Номер", НСтр("ru='Номер документа';uk='Номер документа'"));
мСписокОтборов.Добавить("ВидОперации","");
мСтруктураПредставленийОтборов.Вставить("ВидОперации", НСтр("ru='Вид операции';uk='Вид операції'"));
