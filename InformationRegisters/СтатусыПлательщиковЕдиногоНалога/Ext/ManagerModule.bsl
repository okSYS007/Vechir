Процедура АктуализироватьДанные(НаборЗаписейУчетнойПолитики) Экспорт
	...
	|	УчетнаяПолитикаНалоговыйУчет.СхемаНалогообложения.НДС КАК ПлательщикНДС,
	|   УчетнаяПолитикаНалоговыйУчет.СхемаНалогообложения.ЕдиныйНалог КАК ПлательщикЕдиногоНалога,
	|	УчетнаяПолитикаНалоговыйУчет.ГруппаПлательщикаЕдиногоНалога КАК ГруппаПлательщикаЕдиногоНалога,
	|	УчетнаяПолитикаНалоговыйУчет.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца КАК ДатаИзмененияСхемыНалогообложенияВСерединеМесяца,
	...
	|		ПО Организации.Ссылка = УчетнаяПолитикаНалоговыйУчет.Организация
	|{ГДЕ
	|	Организации.Ссылка.* КАК Организация}
	|
	|УПОРЯДОЧИТЬ ПО
