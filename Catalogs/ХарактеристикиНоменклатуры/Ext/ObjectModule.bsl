...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ОбменДанными.Загрузка
	   И НЕ Владелец.ВестиУчетПоХарактеристикам Тогда
		...
		НСтр("ru='Для номенклатуры ""';uk='Для номенклатури ""'") + Владелец + НСтр("ru='"" не ведется учет по характеристикам."
"Характеристика ""';uk='"" не ведеться облік по характеристиках."
"Характеристика ""'") + Наименование + НСтр("ru='"" не может быть записана.';uk='"" не може бути записана.'"), 
		Отказ);
