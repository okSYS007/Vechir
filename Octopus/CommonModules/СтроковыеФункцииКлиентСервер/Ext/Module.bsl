...
//
// Пример:
//  ПодставитьПараметрыВСтроку(НСтр("en='%1 come to %2';ka='%1 წავიდა %2';ru='%1 пошел в %2';uk='%1 пійшов у %2'"), "Вася", "Зоопарк") = "Вася пошел в Зоопарк".
//
// Примечание:
...
//
//  Строка = ПодставитьПараметрыВСтроку(НСтр("en='%1 come to %2';ka='%1 წავიდა %2';ru='%1 пошел в %2';uk='%1 пійшов у %2'"), МассивПараметров);
//
