...
Процедура КонтрольОстатков(ДокументОбъект, ИмяТабличнойЧасти, СтруктураШапкиДокумента, Отказ, Заголовок) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НСтр("ru=' к получению на склад ';uk=' до отримання на склад '") + СокрЛП(Выборка.Склад) + ?(ЕстьДокументПередачи,НСтр("ru=' по документу ';uk=' по документу '") + СтруктураШапкиДокумента.ДокументПередачи, "")
		+ ?(ЕстьКачество, НСтр("ru=' с качеством ';uk=' з якістю '") + Выборка.Качество, "") 
		+ ?(ЕстьДокументРезерва И ИмяДокумента <> "ПеремещениеТоваров", ?(НЕ ЗначениеЗаполнено(Выборка.ДокументРезерва),"",НСтр("ru=' с документом резерва ';uk=' з документом резерву '") + СокрЛП(Выборка.ДокументРезерва)), "") + НСтр("ru=' недостаточно.';uk=' недостатньо.'");
