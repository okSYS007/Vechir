...
Процедура КонтрольОстатков(ДокументОбъект, ИмяТабличнойЧасти, СтруктураШапкиДокумента, Отказ, Заголовок) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НСтр("ru=', заказанного по документу ';uk=', замовленого по документу '") + (Выборка.ЗаказПоставщику)+?(флКонтролироватьЦену,НСтр("ru=' с ценой ';uk=' з ціною '") + ОбщегоНазначения.ФорматСумм(Выборка.Цена),"") +  НСтр("ru=' недостаточно.';uk=' недостатньо.'");
