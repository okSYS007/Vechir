...
Процедура КонтрольОстатков(ДокументОбъект, ИмяТабличнойЧасти, СтруктураШапкиДокумента, Отказ, Заголовок) Экспорт
   Если ДокументОбъект[ИмяТабличнойЧасти].Количество() = 0 Тогда 
	...
	Если ИмяДокумента = "РеализацияУслугПоПереработке" Тогда
	...
	Пока Выборка.Следующий() Цикл
		...
		НСтр("ru=', заказанного по документу ';uk=', замовленого по документу '") + Выборка.ЗаказПокупателя + 
		?(флКонтролироватьЦену,НСтр("ru=' с ценой ';uk=' з ціною '") + ОбщегоНазначения.ФорматСумм(Выборка.Цена),"")+ 
		?(флКонтролироватьСкидки, НСтр("ru=' с ручной скидкой ';uk=' з ручної знижкою '")+Выборка.ПроцентСкидкиНаценки+НСтр("ru=', с автоматической скидкой ';uk=', з автоматичною знижкою '")+Выборка.ПроцентАвтоматическихСкидок,"")+НСтр("ru=' недостаточно.';uk=' недостатньо.'");
